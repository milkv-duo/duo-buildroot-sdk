...
#define IMX327_FULL_LINES_MAX_2TO1_WDR  (0x3FFFF)    // considering the YOUT_SIZE and bad frame
...
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	if (pstSnsState->u8ImgMode == IMX327_MODE_1080P60)
		fps = 60;
	...
	case WDR_MODE_NONE:   /*linear mode*/
		if (pstSnsState->u8ImgMode == IMX327_MODE_1080P60) {
			pstAeSnsDft->f32Fps = g_astImx327_mode[IMX327_MODE_1080P60].f32MaxFps;
			pstAeSnsDft->f32MinFps = g_astImx327_mode[IMX327_MODE_1080P60].f32MinFps;
		} else {
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		...
		u8SensorImageMode = IMX327_MODE_1080P60;
	}
