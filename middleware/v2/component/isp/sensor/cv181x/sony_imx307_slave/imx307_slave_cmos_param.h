#ifndef __IMX307_SLAVE_CMOS_PARAM_H_
#define __IMX307_SLAVE_CMOS_PARAM_H_
...
static const IMX307_SLAVE_MODE_S g_astImx307_Slave_mode[IMX307_SLAVE_MODE_NUM] = {
	[IMX307_SLAVE_MODE_1080P30] = {
		.name = "1080p30",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 1948,
...
#endif /* __IMX307_SLAVE_CMOS_PARAM_H_ */
