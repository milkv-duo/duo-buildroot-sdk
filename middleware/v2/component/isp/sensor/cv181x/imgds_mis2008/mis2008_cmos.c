...
#include "mis2008_cmos_param.h"

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define MIS2008_ID 2008
#define SENSOR_MIS2008_WIDTH 1920
#define SENSOR_MIS2008_HEIGHT 1080
#define MIS2008_I2C_ADDR_1 0x30
#define MIS2008_I2C_ADDR_2 0x32
#define MIS2008_I2C_ADDR_IS_VALID(addr)	((addr) == MIS2008_I2C_ADDR_1 || (addr) == MIS2008_I2C_ADDR_2)

#define MIS2008_EXPACCURACY                    (1)

/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastMIS2008[VI_MAX_PIPE_NUM] = {CVI_NULL};
...
#define MIS2008_SENSOR_RESET_CTX(dev)         (g_pastMIS2008[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunMIS2008_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

CVI_U16 g_au16MIS2008_GainMode[VI_MAX_PIPE_NUM] = {0};
CVI_U16 g_au16MIS2008_L2SMode[VI_MAX_PIPE_NUM] = {0};

ISP_SNS_MIRRORFLIP_TYPE_E g_aeMis2008_MirrorFip[VI_MAX_PIPE_NUM] = {0};
...
/*****MIS2008 Lines Range*****/
#define MIS2008_FULL_LINES_MAX  (0xFFFF)
...
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	pstAeSnsDft->u32FullLinesMax = MIS2008_FULL_LINES_MAX;
	pstAeSnsDft->u32HmaxTimes = (1000000) / (pstSnsState->u32FLStd * 30);

	pstAeSnsDft->stIntTimeAccu.enAccuType = AE_ACCURACY_LINEAR;
	pstAeSnsDft->stIntTimeAccu.f32Accuracy = MIS2008_EXPACCURACY;
	...
	case WDR_MODE_NONE:   /*linear mode*/
		pstAeSnsDft->f32Fps = g_astMIS2008_mode[pstSnsState->u8ImgMode].f32MaxFps;
		pstAeSnsDft->f32MinFps = g_astMIS2008_mode[pstSnsState->u8ImgMode].f32MinFps;
		pstAeSnsDft->au8HistThresh[0] = 0xd;
		pstAeSnsDft->au8HistThresh[1] = 0x28;
		pstAeSnsDft->au8HistThresh[2] = 0x60;
		pstAeSnsDft->au8HistThresh[3] = 0x80;

		pstAeSnsDft->u32MaxAgain = g_astMIS2008_mode[pstSnsState->u8ImgMode].stAgain[0].u32Max;
		pstAeSnsDft->u32MinAgain = g_astMIS2008_mode[pstSnsState->u8ImgMode].stAgain[0].u32Min;
		pstAeSnsDft->u32MaxAgainTarget = pstAeSnsDft->u32MaxAgain;
		pstAeSnsDft->u32MinAgainTarget = pstAeSnsDft->u32MinAgain;

		pstAeSnsDft->u32MaxDgain = g_astMIS2008_mode[pstSnsState->u8ImgMode].stDgain[0].u32Max;
		pstAeSnsDft->u32MinDgain = g_astMIS2008_mode[pstSnsState->u8ImgMode].stDgain[0].u32Min;
		...
		pstAeSnsDft->u32MaxIntTime = g_astMIS2008_mode[pstSnsState->u8ImgMode].stExp[0].u32Max;
		pstAeSnsDft->u32MinIntTime = g_astMIS2008_mode[pstSnsState->u8ImgMode].stExp[0].u32Min;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_astMIS2008_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astMIS2008_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astMIS2008_mode[pstSnsState->u8ImgMode].f32MinFps;

	switch (pstSnsState->u8ImgMode) {
	case MIS2008_MODE_1080P30:
		...
		u32VMAX = (u32VMAX > MIS2008_FULL_LINES_MAX) ? MIS2008_FULL_LINES_MAX : u32VMAX;
		break;
	default:
		CVI_TRACE_SNS(CVI_DBG_ERR, "Not support sensor mode: %d\n", pstSnsState->u8ImgMode);
		return CVI_FAILURE;
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	...
	pstSnsRegsInfo->astI2cData[LINEAR_D_FINEGAIN_ADDR].u32Data =((info->regGain & 0x01)<<7) | ((u32Dgain & 0x0F)<<3);
	return CVI_SUCCESS;
}
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const MIS2008_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	MIS2008_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);
	pstMode = &g_astMIS2008_mode[pstSnsState->u8ImgMode];
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		pstSnsState->u8ImgMode = MIS2008_MODE_1080P30;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astMIS2008_mode[pstSnsState->u8ImgMode].u32VtsDef;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunMIS2008_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = mis2008_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = mis2008_addr_byte;
			pstI2c_data[i].u32DataByteNum = mis2008_data_byte;
		}
		switch (pstSnsState->enWDRMode) {
		case WDR_MODE_NONE:
			//Linear Mode Regs
			pstI2c_data[LINEAR_SHS1_0_ADDR].u32RegAddr     = MIS2008_EXP_ADDR;
			pstI2c_data[LINEAR_SHS1_1_ADDR].u32RegAddr     = MIS2008_EXP_ADDR + 1;

			pstI2c_data[LINEAR_AGAIN_ADDR].u32RegAddr      = MIS2008_AGAIN_ADDR;
			pstI2c_data[LINEAR_DGAIN_ADDR].u32RegAddr      = MIS2008_DGAIN_ADDR;
			pstI2c_data[LINEAR_D_FINEGAIN_ADDR].u32RegAddr = MIS2008_DGAIN_ADDR + 1;

			pstI2c_data[LINEAR_VMAX_0_ADDR].u32RegAddr     = MIS2008_VMAX_ADDR;
			pstI2c_data[LINEAR_VMAX_1_ADDR].u32RegAddr     = MIS2008_VMAX_ADDR + 1;
			pstI2c_data[LINEAR_FLIP_MIRROR_ADDR].u32RegAddr     = MIS2008_FLIP_MIRROR_ADDR;
			break;
		default:
			CVI_TRACE_SNS(CVI_DBG_ERR, "NOT support this mode!\n");
			return CVI_FAILURE;
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (MIS2008_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = MIS2008_MODE_1080P30;
			} else {
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	if (pstSnsState->bInit == CVI_TRUE && g_aeMis2008_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		...
		g_aeMis2008_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &mis2008_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_astMIS2008_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astMIS2008_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &mis2008_rx_attr;
	int i;
...
{
	if (MIS2008_I2C_ADDR_IS_VALID(s32I2cAddr))
		mis2008_i2c_addr = s32I2cAddr;
}

static CVI_S32 mis2008_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunMIS2008_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, MIS2008_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, MIS2008_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, MIS2008_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16MIS2008_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16MIS2008_L2SMode[ViPipe] = pstInitAttr->enL2SMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsMIS2008_Obj = {
	...
	.pfnSetBusInfo		= mis2008_set_bus_info,
