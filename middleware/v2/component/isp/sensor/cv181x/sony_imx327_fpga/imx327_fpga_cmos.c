...
#include "imx327_fpga_cmos_param.h"
...
IMX327_FPGA_STATE_S g_astImx327_fpga_State[VI_MAX_PIPE_NUM] = {{0} };
ISP_SNS_MIRRORFLIP_TYPE_E g_aeImx327_fpga_MirrorFip[VI_MAX_PIPE_NUM] = {0};
...
/*****Imx327 Lines Range*****/
#define IMX327_FPGA_FULL_LINES_MAX  (0x3FFFF)
#define IMX327_FPGA_FULL_LINES_MAX_2TO1_WDR  (0x3FFFF)    // considering the YOUT_SIZE and bad frame
#define IMX327_FPGA_VMAX_1080P30_LINEAR	1125
#define IMX327_FPGA_VMAX_720P30_LINEAR	750

/*****Imx327 Register Address*****/
#define IMX327_FPGA_HOLD_ADDR		0x3001
#define IMX327_FPGA_SHS1_ADDR		0x3020
#define IMX327_FPGA_SHS2_ADDR		0x3024
#define IMX327_FPGA_GAIN_ADDR		0x3014
#define IMX327_FPGA_GAIN1_ADDR		0x30F2
#define IMX327_FPGA_HCG_ADDR			0x3009
#define IMX327_FPGA_VMAX_ADDR		0x3018
#define IMX327_FPGA_YOUT_ADDR		0x3418
#define IMX327_FPGA_RHS1_ADDR		0x3030
#define IMX327_FPGA_TABLE_END		0xffff

#define IMX327_FPGA_RES_IS_1080P(w, h)      ((w) <= 1920 && (h) <= 1080)
#define IMX327_FPGA_RES_IS_720P(w, h)      ((w) <= 1280 && (h) <= 720)
...
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	case WDR_MODE_NONE:   /*linear mode*/
		if (pstSnsState->u8ImgMode == IMX327_FPGA_MODE_1080P30) {
			pstAeSnsDft->f32Fps = g_astImx327_fpga_mode[IMX327_FPGA_MODE_1080P30].f32MaxFps;
			pstAeSnsDft->f32MinFps = g_astImx327_fpga_mode[IMX327_FPGA_MODE_1080P30].f32MinFps;
		} else {
			pstAeSnsDft->f32Fps = g_astImx327_fpga_mode[IMX327_FPGA_MODE_720P30].f32MaxFps;
			pstAeSnsDft->f32MinFps = g_astImx327_fpga_mode[IMX327_FPGA_MODE_720P30].f32MinFps;
		}
	...
	case WDR_MODE_2To1_LINE:
		if (pstSnsState->u8ImgMode == IMX327_FPGA_MODE_1080P30_WDR) {
			pstAeSnsDft->f32Fps = g_astImx327_fpga_mode[IMX327_FPGA_MODE_1080P30_WDR].f32MaxFps;
			pstAeSnsDft->f32MinFps = g_astImx327_fpga_mode[IMX327_FPGA_MODE_1080P30_WDR].f32MinFps;
		} else {
			pstAeSnsDft->f32Fps = g_astImx327_fpga_mode[IMX327_FPGA_MODE_720P30_WDR].f32MaxFps;
			pstAeSnsDft->f32MinFps = g_astImx327_fpga_mode[IMX327_FPGA_MODE_720P30_WDR].f32MinFps;
		}
...
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	CVI_U32 u32VMAX = IMX327_FPGA_VMAX_1080P30_LINEAR;
	...
	u32Vts = g_astImx327_fpga_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astImx327_fpga_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astImx327_fpga_mode[pstSnsState->u8ImgMode].f32MinFps;

	switch (pstSnsState->u8ImgMode) {
	case IMX327_FPGA_MODE_1080P30_WDR:
		...
		u32VMAX = (u32VMAX > IMX327_FPGA_FULL_LINES_MAX_2TO1_WDR) ?
			IMX327_FPGA_FULL_LINES_MAX_2TO1_WDR : u32VMAX;
		break;

	case IMX327_FPGA_MODE_1080P30:
		if ((f32Fps <= f32MaxFps) && (f32Fps >= f32MinFps)) {
			u32VMAX = u32Vts * f32MaxFps / DIV_0_TO_1_FLOAT(f32Fps);
		} else {
			CVI_TRACE_SNS(CVI_DBG_ERR, "Unsupport Fps: %f\n", f32Fps);
		...
		u32VMAX = (u32VMAX > IMX327_FPGA_FULL_LINES_MAX) ? IMX327_FPGA_FULL_LINES_MAX : u32VMAX;
		break;
	case IMX327_FPGA_MODE_720P30:
	case IMX327_FPGA_MODE_720P30_WDR:
		if ((f32Fps <= f32MaxFps) && (f32Fps >= f32MinFps)) {
			u32VMAX = u32Vts * f32MaxFps / DIV_0_TO_1_FLOAT(f32Fps);
		} else {
			CVI_TRACE_SNS(CVI_DBG_ERR, "Unsupport Fps: %f\n", f32Fps);
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		g_astImx327_fpga_State[ViPipe].u32RHS1_MAX = (u32VMAX - g_astImx327_fpga_State[ViPipe].u32BRL) * 2 - 21;
	} else {
...
static CVI_S32 cmos_inttime_update(VI_PIPE ViPipe, CVI_U32 *u32IntTime)
{
	...
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	u16BRL = g_astImx327_fpga_mode[pstSnsState->u8ImgMode].u16BRL;
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		if (pstSnsState->au32FL[1] < u32LongIntTime - 1) {
			CVI_TRACE_SNS(CVI_DBG_ERR, "WDR FL %d is smaller than  = %d\n",
		...
		g_astImx327_fpga_State[ViPipe].u32RHS1 = u32RHS1;
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	ISP_SNS_REGS_INFO_S *pstSnsRegsInfo = CVI_NULL;
	CVI_U32 u32HCG = g_astImx327_fpga_State[ViPipe].u8Hcg;
	CVI_U32 u16Mode = g_au16Imx327_fpga_GainMode[ViPipe];
	CVI_U32 u32Tmp;
	CVI_U32 u32Again;
	CVI_U32 u32Dgain;
		...
		CVI_U32 *au32IntTimeMax, CVI_U32 *au32IntTimeMin, CVI_U32 *pu32LFMaxIntTime)
{
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		u32IntTimeMaxTmp  = (u32IntTimeMaxTmp > (g_astImx327_fpga_State[ViPipe].u32RHS1_MAX - 3)) ?
						(g_astImx327_fpga_State[ViPipe].u32RHS1_MAX - 3) : u32IntTimeMaxTmp;
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const IMX327_FPGA_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	IMX327_FPGA_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);
	pstMode = &g_astImx327_fpga_mode[pstSnsState->u8ImgMode];
	...
	if (pstSnsState->enWDRMode != WDR_MODE_NONE) {
		 ...
		 */
		// u32VBP1 = (g_astImx327_fpga_State[ViPipe].u32RHS1  - 1) >> 1;
		// u32VBP1_MAX = (g_astImx327_fpga_State[ViPipe].u32RHS1_MAX - 1) >> 1;
		pstIspCfg->frm_num = 2;
		memcpy(&pstIspCfg->img_size[0], &pstMode->astImg[0], sizeof(ISP_WDR_SIZE_S));
		memcpy(&pstIspCfg->img_size[1], &pstMode->astImg[1], sizeof(ISP_WDR_SIZE_S));
		// pstIspCfg->img_size[1].stSnsSize.u32Height = pstMode->u16BRL + u32VBP1;
		// pstIspCfg->img_size[1].stWndRect.s32Y = pstMode->u16OpbSize + pstMode->u16MarginVtop;
		// pstIspCfg->img_size[1].stMaxSize.u32Height = pstMode->u16BRL + u32VBP1_MAX;
		// pstIspCfg->img_size[0].stSnsSize.u32Height = pstIspCfg->img_size[1].stSnsSize.u32Height;
		// pstIspCfg->img_size[0].stWndRect.s32Y = pstMode->u16OpbSize + pstMode->u16MarginVtop + u32VBP1;
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	case WDR_MODE_NONE:
		if (pstSnsState->u8ImgMode == IMX327_FPGA_MODE_1080P30_WDR)
			pstSnsState->u8ImgMode = IMX327_FPGA_MODE_1080P30;
		else if (pstSnsState->u8ImgMode == IMX327_FPGA_MODE_720P30_WDR)
			pstSnsState->u8ImgMode = IMX327_FPGA_MODE_720P30;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astImx327_fpga_mode[pstSnsState->u8ImgMode].u32VtsDef;
	...
	case WDR_MODE_2To1_LINE:
		if (pstSnsState->u8ImgMode == IMX327_FPGA_MODE_1080P30)
			pstSnsState->u8ImgMode = IMX327_FPGA_MODE_1080P30_WDR;
		else if (pstSnsState->u8ImgMode == IMX327_FPGA_MODE_720P30)
		...
		if (pstSnsState->u8ImgMode == IMX327_FPGA_MODE_1080P30_WDR) {
			...
			pstSnsState->u32FLStd = g_astImx327_fpga_mode[pstSnsState->u8ImgMode].u32VtsDef * 2;
			g_astImx327_fpga_State[ViPipe].u32BRL  = g_astImx327_fpga_mode[pstSnsState->u8ImgMode].u16BRL;
			syslog(LOG_INFO, "WDR_MODE_2To1_LINE 720P\n");
		}
		break;
	default:
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunImx327_fpga_BusInfo[ViPipe].s8I2cDev;
		...
		switch (pstSnsState->enWDRMode) {
		case WDR_MODE_2To1_LINE:
			pstI2c_data[DOL2_HOLD].u32RegAddr = IMX327_FPGA_HOLD_ADDR;
			pstI2c_data[DOL2_HOLD].u32Data = 1;
			pstI2c_data[DOL2_SHS1_0].u32RegAddr = IMX327_FPGA_SHS1_ADDR;
			pstI2c_data[DOL2_SHS1_1].u32RegAddr = IMX327_FPGA_SHS1_ADDR + 1;
			pstI2c_data[DOL2_SHS1_2].u32RegAddr = IMX327_FPGA_SHS1_ADDR + 2;

			pstI2c_data[DOL2_GAIN].u32RegAddr = IMX327_FPGA_GAIN_ADDR;
			pstI2c_data[DOL2_HCG].u32RegAddr = IMX327_FPGA_HCG_ADDR;
			pstI2c_data[DOL2_HCG].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_GAIN1].u32RegAddr = IMX327_FPGA_GAIN1_ADDR;
			pstI2c_data[DOL2_RHS1_0].u32RegAddr = IMX327_FPGA_RHS1_ADDR;
			pstI2c_data[DOL2_RHS1_0].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_RHS1_1].u32RegAddr = IMX327_FPGA_RHS1_ADDR + 1;
			pstI2c_data[DOL2_RHS1_1].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_RHS1_2].u32RegAddr = IMX327_FPGA_RHS1_ADDR + 2;
			pstI2c_data[DOL2_RHS1_2].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_SHS2_0].u32RegAddr = IMX327_FPGA_SHS2_ADDR;
			pstI2c_data[DOL2_SHS2_1].u32RegAddr = IMX327_FPGA_SHS2_ADDR + 1;
			pstI2c_data[DOL2_SHS2_2].u32RegAddr = IMX327_FPGA_SHS2_ADDR + 2;
			pstI2c_data[DOL2_VMAX_0].u32RegAddr = IMX327_FPGA_VMAX_ADDR;
			pstI2c_data[DOL2_VMAX_0].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_VMAX_1].u32RegAddr = IMX327_FPGA_VMAX_ADDR + 1;
			pstI2c_data[DOL2_VMAX_1].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_VMAX_2].u32RegAddr = IMX327_FPGA_VMAX_ADDR + 2;
			pstI2c_data[DOL2_VMAX_2].u8DelayFrmNum = 1;

			pstI2c_data[DOL2_YOUT_SIZE_0].u32RegAddr = IMX327_FPGA_YOUT_ADDR;
			pstI2c_data[DOL2_YOUT_SIZE_0].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_YOUT_SIZE_1].u32RegAddr = IMX327_FPGA_YOUT_ADDR + 1;
			pstI2c_data[DOL2_YOUT_SIZE_1].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_REL].u32RegAddr = IMX327_FPGA_HOLD_ADDR;
			pstI2c_data[DOL2_REL].u32Data = 0;
			pstCfg0->ispCfg.u8DelayFrmNum = 1;
			break;
		default:
			pstI2c_data[LINEAR_HOLD].u32RegAddr = IMX327_FPGA_HOLD_ADDR;
			pstI2c_data[LINEAR_HOLD].u32Data = 1;
			pstI2c_data[LINEAR_SHS1_0].u32RegAddr = IMX327_FPGA_SHS1_ADDR;
			pstI2c_data[LINEAR_SHS1_1].u32RegAddr = IMX327_FPGA_SHS1_ADDR + 1;
			pstI2c_data[LINEAR_SHS1_2].u32RegAddr = IMX327_FPGA_SHS1_ADDR + 2;
			pstI2c_data[LINEAR_GAIN].u32RegAddr = IMX327_FPGA_GAIN_ADDR;
			pstI2c_data[LINEAR_HCG].u32RegAddr = IMX327_FPGA_HCG_ADDR;
			pstI2c_data[LINEAR_HCG].u8DelayFrmNum = 1;
			pstI2c_data[LINEAR_VMAX_0].u32RegAddr = IMX327_FPGA_VMAX_ADDR;
			pstI2c_data[LINEAR_VMAX_1].u32RegAddr = IMX327_FPGA_VMAX_ADDR + 1;
			pstI2c_data[LINEAR_VMAX_2].u32RegAddr = IMX327_FPGA_VMAX_ADDR + 2;
			pstI2c_data[LINEAR_REL].u32RegAddr = IMX327_FPGA_HOLD_ADDR;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 10) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			...
			} else if (IMX327_FPGA_RES_IS_1080P(pstSensorImageMode->u16Width,
				pstSensorImageMode->u16Height)) {
				u8SensorImageMode = IMX327_FPGA_MODE_1080P30;
			} else {
			...
			if (IMX327_FPGA_RES_IS_720P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = IMX327_FPGA_MODE_720P30_WDR;
				CVI_TRACE_SNS(CVI_DBG_ERR, "enter IMX327_FPGA_MODE_720P30_WDR mode\n");
			} else if (IMX327_FPGA_RES_IS_1080P(pstSensorImageMode->u16Width,
				pstSensorImageMode->u16Height)) {
				u8SensorImageMode = IMX327_FPGA_MODE_1080P30_WDR;
				g_astImx327_fpga_State[ViPipe].u32BRL = 1109;
			} else {
				CVI_TRACE_SNS(CVI_DBG_ERR, "Not support! Width:%d, Height:%d, Fps:%f, WDRMode:%d\n",
				       pstSensorImageMode->u16Width,
				       pstSensorImageMode->u16Height,
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	if (pstSnsState->bInit == CVI_TRUE && g_aeImx327_fpga_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		imx327_fpga_mirror_flip(ViPipe, eSnsMirrorFlip);
		g_aeImx327_fpga_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
}
...
static CVI_VOID sensor_global_init(VI_PIPE ViPipe)
{
	...
	pstSnsState->u8ImgMode = IMX327_FPGA_MODE_720P30_WDR;
	// pstSnsState->u8ImgMode = IMX327_FPGA_MODE_1080P30;
	pstSnsState->u32FLStd  = IMX327_FPGA_VMAX_720P30_LINEAR;
	pstSnsState->au32FL[0] = IMX327_FPGA_VMAX_720P30_LINEAR;
	pstSnsState->au32FL[1] = IMX327_FPGA_VMAX_720P30_LINEAR;
	// pstSnsState->u32FLStd  = IMX327_FPGA_VMAX_1080P30_LINEAR;
	// pstSnsState->au32FL[0] = IMX327_FPGA_VMAX_1080P30_LINEAR;
	// pstSnsState->au32FL[1] = IMX327_FPGA_VMAX_1080P30_LINEAR;
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	pstRxAttr->img_size.width = g_astImx327_fpga_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astImx327_fpga_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode != WDR_MODE_NONE) {
		CVI_TRACE_SNS(CVI_DBG_INFO, "sensor_rx_attr/enWDRMode=%d\n", pstSnsState->enWDRMode);
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = imx327_fpga_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = imx327_fpga_exit;
...
{
	g_aunImx327_fpga_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	IMX327_FPGA_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = IMX327_FPGA_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, IMX327_FPGA_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, IMX327_FPGA_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, IMX327_FPGA_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16Imx327_fpga_GainMode[ViPipe] = pstInitAttr->enGainMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsImx327_fpga_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = imx327_fpga_standby,
	.pfnRestart             = imx327_fpga_restart,
	.pfnMirrorFlip          = sensor_mirror_flip,
	.pfnWriteReg            = imx327_fpga_write_register,
	.pfnReadReg             = imx327_fpga_read_register,
