...
#include "sc2336_slave_cmos_param.h"

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define SC2336_SLAVE_ID 35
#define SENSOR_SC2336_SLAVE_WIDTH 1920
#define SENSOR_SC2336_SLAVE_HEIGHT 1080
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastSC2336_Slave[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define SC2336_SLAVE_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastSC2336_Slave[dev])
#define SC2336_SLAVE_SENSOR_SET_CTX(dev, pstCtx)   (g_pastSC2336_Slave[dev] = pstCtx)
#define SC2336_SLAVE_SENSOR_RESET_CTX(dev)         (g_pastSC2336_Slave[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunSC2336_Slave_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
...
SC2336_SLAVE_STATE_S g_astSC2336_Slave_State[VI_MAX_PIPE_NUM] = {{0} };
...
#define SC2336_SLAVE_FULL_LINES_MAX  (0xFFFF)

/*****SC2336_SLAVE Register Address*****/
#define SC2336_SLAVE_SHS1_0_ADDR		0x3E00
#define SC2336_SLAVE_SHS1_1_ADDR		0x3E01
#define SC2336_SLAVE_SHS1_2_ADDR		0x3E02
#define SC2336_SLAVE_AGAIN0_ADDR		0x3E09
#define SC2336_SLAVE_DGAIN0_ADDR		0x3E06
#define SC2336_SLAVE_VMAX_ADDR		0x320E
#define SC2336_SLAVE_TABLE_END		0xFFFF

#define SC2336_SLAVE_RES_IS_1080P(w, h)      ((w) <= 1920 && (h) <= 1080)

static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	const SC2336_SLAVE_MODE_S *pstMode;
	...
	pstAeSnsDft->u32FullLinesMax = SC2336_SLAVE_FULL_LINES_MAX;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	case SC2336_SLAVE_MODE_1080P30:
		...
		u32VMAX = (u32VMAX > SC2336_SLAVE_FULL_LINES_MAX) ? SC2336_SLAVE_FULL_LINES_MAX : u32VMAX;
		break;
	default:
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const SC2336_SLAVE_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		pstSnsState->u8ImgMode = SC2336_SLAVE_MODE_1080P30;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunSC2336_Slave_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = sc2336_slave_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = sc2336_slave_addr_byte;
			pstI2c_data[i].u32DataByteNum = sc2336_slave_data_byte;
		}
		...
		default:
			//Linear Mode Regs
			pstI2c_data[LINEAR_SHS1_0_ADDR].u32RegAddr = SC2336_SLAVE_SHS1_0_ADDR;
			pstI2c_data[LINEAR_SHS1_1_ADDR].u32RegAddr = SC2336_SLAVE_SHS1_1_ADDR;
			pstI2c_data[LINEAR_SHS1_2_ADDR].u32RegAddr = SC2336_SLAVE_SHS1_2_ADDR;
			pstI2c_data[LINEAR_AGAIN_0_ADDR].u32RegAddr = SC2336_SLAVE_AGAIN0_ADDR;
			pstI2c_data[LINEAR_DGAIN_0_ADDR].u32RegAddr = SC2336_SLAVE_DGAIN0_ADDR;
			pstI2c_data[LINEAR_DGAIN_1_ADDR].u32RegAddr = SC2336_SLAVE_DGAIN0_ADDR + 1;
			// pstI2c_data[LINEAR_VMAX_0_ADDR].u32RegAddr = SC2336_SLAVE_VMAX_ADDR;
			// pstI2c_data[LINEAR_VMAX_1_ADDR].u32RegAddr = SC2336_SLAVE_VMAX_ADDR + 1;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (SC2336_SLAVE_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC2336_SLAVE_MODE_1080P30;
			} else {
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &sc2336_slave_rx_attr, sizeof(*pstRxAttr));
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &sc2336_slave_rx_attr;
	int i;
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = sc2336_slave_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = sc2336_slave_exit;
...
static CVI_S32 sc2336_slave_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunSC2336_Slave_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	SC2336_SLAVE_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = SC2336_SLAVE_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, SC2336_SLAVE_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, SC2336_SLAVE_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, SC2336_SLAVE_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16SC2336_Slave_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16SC2336_Slave_L2SMode[ViPipe] = pstInitAttr->enL2SMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsSC2336_Slave_Obj = {
	...
	.pfnSnsProbe		= sc2336_slave_probe,
};
