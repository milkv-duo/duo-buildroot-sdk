...
#define SENSOR_SC500AI_WIDTH 2880
#define SENSOR_SC500AI_HEIGHT 1620
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastSC500AI[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define SC500AI_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastSC500AI[dev])
#define SC500AI_SENSOR_SET_CTX(dev, pstCtx)   (g_pastSC500AI[dev] = pstCtx)
#define SC500AI_SENSOR_RESET_CTX(dev)         (g_pastSC500AI[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunSC500AI_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

CVI_U16 g_au16SC500AI_GainMode[VI_MAX_PIPE_NUM] = {0};
CVI_U16 g_au16SC500AI_L2SMode[VI_MAX_PIPE_NUM] = {0};

SC500AI_STATE_S g_astSC500AI_State[VI_MAX_PIPE_NUM] = {{0} };
...
/*****SC500AI Lines Range*****/
#define SC500AI_FULL_LINES_MAX  (0x7FFF)
#define SC500AI_FULL_LINES_MAX_2TO1_WDR  (0x7FFF)

/*****SC500AI Register Address*****/
#define SC500AI_SHS1_0_ADDR		0x3E00
#define SC500AI_SHS1_1_ADDR		0x3E01
#define SC500AI_SHS1_2_ADDR		0x3E02
#define SC500AI_SHS2_0_ADDR		0x3E22
#define SC500AI_SHS2_1_ADDR		0x3E04
#define SC500AI_SHS2_2_ADDR		0x3E05
#define SC500AI_AGAIN1_ADDR		0x3E08
#define SC500AI_DGAIN1_ADDR		0x3E06
#define SC500AI_AGAIN2_ADDR		0x3E12
#define SC500AI_DGAIN2_ADDR		0x3E10
#define SC500AI_VMAX_ADDR		0x320E
#define SC500AI_MAXSEXP_ADDR		0x3E23
#define SC500AI_TABLE_END		0xFFFF

#define SC500AI_RES_IS_1620P(w, h)      ((w) <= 2880 && (h) <= 1620)
#define SC500AI_RES_IS_1440P(w, h)      ((w) <= 2560 && (h) <= 1440)
...
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	case WDR_MODE_2To1_LINE:
		pstAeSnsDft->f32Fps = g_astSC500AI_mode[SC500AI_MODE_1620P30_WDR].f32MaxFps;
		pstAeSnsDft->f32MinFps = g_astSC500AI_mode[SC500AI_MODE_1620P30_WDR].f32MinFps;
		...
		pstAeSnsDft->u32MaxAgain = g_astSC500AI_mode[SC500AI_MODE_1620P30_WDR].stAgain[0].u32Max;
		pstAeSnsDft->u32MinAgain = g_astSC500AI_mode[SC500AI_MODE_1620P30_WDR].stAgain[0].u32Min;
		pstAeSnsDft->u32MaxAgainTarget = pstAeSnsDft->u32MaxAgain;
		pstAeSnsDft->u32MinAgainTarget = pstAeSnsDft->u32MinAgain;

		pstAeSnsDft->u32MaxDgain = g_astSC500AI_mode[SC500AI_MODE_1620P30_WDR].stDgain[0].u32Max;
		pstAeSnsDft->u32MinDgain = g_astSC500AI_mode[SC500AI_MODE_1620P30_WDR].stDgain[0].u32Min;
		pstAeSnsDft->u32MaxDgainTarget = pstAeSnsDft->u32MaxDgain;
		pstAeSnsDft->u32MinDgainTarget = pstAeSnsDft->u32MinDgain;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_astSC500AI_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astSC500AI_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astSC500AI_mode[pstSnsState->u8ImgMode].f32MinFps;
	u16MaxSexpReg = g_astSC500AI_mode[pstSnsState->u8ImgMode].u16SexpMaxReg;

	switch (pstSnsState->u8ImgMode) {
	case SC500AI_MODE_1620P30_WDR:
	case SC500AI_MODE_1440P30_WDR:
		...
		u32VMAX = (u32VMAX > SC500AI_FULL_LINES_MAX_2TO1_WDR) ? SC500AI_FULL_LINES_MAX_2TO1_WDR : u32VMAX;
		break;
	...
	case SC500AI_MODE_1440P30:
		...
		u32VMAX = (u32VMAX > SC500AI_FULL_LINES_MAX) ? SC500AI_FULL_LINES_MAX : u32VMAX;
		break;
	default:
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		g_astSC500AI_State[ViPipe].u32Sexp_MAX = u16MaxSexpReg;
	}
...
static CVI_S32 cmos_inttime_update(VI_PIPE ViPipe, CVI_U32 *u32IntTime)
{
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		CVI_U32 u32MaxLExp;
		CVI_U32 u32MaxSexp = 2 * g_astSC500AI_State[ViPipe].u32Sexp_MAX - 14;

		/* short exposure reg range:
		 * min : 5
		 * max : 2 * reg_sexp_max - 14
		 * step : 4
		 */
		pstSnsState->au32WDRIntTime[0] = (u32ShortIntTime > u32MaxSexp) ? u32MaxSexp : u32ShortIntTime;
		if (pstSnsState->au32WDRIntTime[0] < 5)
			pstSnsState->au32WDRIntTime[0] = 5;
		u16SexpReg = ((CVI_U16)pstSnsState->au32WDRIntTime[0] & ~0x3) + 1;
		pstSnsState->au32WDRIntTime[0] =  u16SexpReg;
		u32IntTime[0] = pstSnsState->au32WDRIntTime[0];

		/* long exposure reg range:
		 * min : 5
		 * max : 2 * (vts - max sexp) - 18
		 * step : 4
		 */
		u32MaxLExp = 2 * (pstSnsState->au32FL[0] - g_astSC500AI_State[ViPipe].u32Sexp_MAX) - 18;
		...
		u16LexpReg = ((CVI_U16)pstSnsState->au32WDRIntTime[1] & ~0x3) + 1;
...
static CVI_S32 cmos_dgain_calc_table(VI_PIPE ViPipe, CVI_U32 *pu32DgainLin, CVI_U32 *pu32DgainDb)
{
	...
	/* range check */
	if (dgain > g_astSC500AI_mode[pstSnsState->u8ImgMode].stDgain[0].u32Max) {
		*pu32DgainLin = g_astSC500AI_mode[pstSnsState->u8ImgMode].stDgain[0].u32Max;
		*pu32DgainDb = g_astSC500AI_mode[pstSnsState->u8ImgMode].stDgain[0].u32Max;
		return CVI_SUCCESS;
	}
	if (dgain < 1024) {
		*pu32DgainLin = 1024;
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	...
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	ISP_SNS_REGS_INFO_S *pstSnsRegsInfo = CVI_NULL;
	CVI_U32 u16Mode = g_au16SC500AI_GainMode[ViPipe];
	CVI_U32 u32Again;
	CVI_U32 u32Dgain;
	...
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
		...
		if (u32Dgain > g_astSC500AI_mode[pstSnsState->u8ImgMode].stDgain[0].u32Max)
			u32Dgain = g_astSC500AI_mode[pstSnsState->u8ImgMode].stDgain[0].u32Max;
		if (u32Dgain < 1024)
			u32Dgain = 1024;
		/* find the base then use 1/128 as step */
		if (u32Dgain < 2048) {
		...
		if (u16Mode == SNS_GAIN_MODE_WDR_2F) {
			...
			pstSnsRegsInfo->astI2cData[WDR2_DGAIN2_0_ADDR].u32Data = (dgainReg & 0xFF);
			...
			pstSnsRegsInfo->astI2cData[WDR2_DGAIN1_0_ADDR].u32Data = (dgainReg & 0xFF);
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const SC500AI_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	SC500AI_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);
	pstMode = &g_astSC500AI_mode[pstSnsState->u8ImgMode];
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		if (pstSnsState->u8ImgMode == SC500AI_MODE_1620P30_WDR)
			pstSnsState->u8ImgMode = SC500AI_MODE_1620P30;
		else if (pstSnsState->u8ImgMode == SC500AI_MODE_1440P30_WDR)
			pstSnsState->u8ImgMode = SC500AI_MODE_1440P30;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astSC500AI_mode[pstSnsState->u8ImgMode].u32VtsDef;
		syslog(LOG_INFO, "linear mode\n");
		break;

	case WDR_MODE_2To1_LINE:
		if (pstSnsState->u8ImgMode == SC500AI_MODE_1620P30)
			pstSnsState->u8ImgMode = SC500AI_MODE_1620P30_WDR;
		else if (pstSnsState->u8ImgMode == SC500AI_MODE_1440P30)
			pstSnsState->u8ImgMode = SC500AI_MODE_1440P30_WDR;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunSC500AI_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = sc500ai_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = sc500ai_addr_byte;
			pstI2c_data[i].u32DataByteNum = sc500ai_data_byte;
		}
		...
		case WDR_MODE_2To1_LINE:
			//WDR Mode Regs
			pstI2c_data[WDR2_SHS1_0_ADDR].u32RegAddr = SC500AI_SHS1_0_ADDR;
			pstI2c_data[WDR2_SHS1_1_ADDR].u32RegAddr = SC500AI_SHS1_1_ADDR;
			pstI2c_data[WDR2_SHS1_2_ADDR].u32RegAddr = SC500AI_SHS1_2_ADDR;
			pstI2c_data[WDR2_SHS2_0_ADDR].u32RegAddr = SC500AI_SHS2_0_ADDR;
			pstI2c_data[WDR2_SHS2_1_ADDR].u32RegAddr = SC500AI_SHS2_1_ADDR;
			pstI2c_data[WDR2_SHS2_2_ADDR].u32RegAddr = SC500AI_SHS2_2_ADDR;
			pstI2c_data[WDR2_AGAIN1_0_ADDR].u32RegAddr = SC500AI_AGAIN1_ADDR;
			pstI2c_data[WDR2_AGAIN1_1_ADDR].u32RegAddr = SC500AI_AGAIN1_ADDR + 1;
			pstI2c_data[WDR2_DGAIN1_0_ADDR].u32RegAddr = SC500AI_DGAIN1_ADDR;
			pstI2c_data[WDR2_DGAIN1_1_ADDR].u32RegAddr = SC500AI_DGAIN1_ADDR + 1;
			pstI2c_data[WDR2_AGAIN2_0_ADDR].u32RegAddr = SC500AI_AGAIN2_ADDR;
			pstI2c_data[WDR2_AGAIN2_1_ADDR].u32RegAddr = SC500AI_AGAIN2_ADDR + 1;
			pstI2c_data[WDR2_DGAIN2_0_ADDR].u32RegAddr = SC500AI_DGAIN2_ADDR;
			pstI2c_data[WDR2_DGAIN2_1_ADDR].u32RegAddr = SC500AI_DGAIN2_ADDR + 1;
			pstI2c_data[WDR2_VMAX_0_ADDR].u32RegAddr = SC500AI_VMAX_ADDR;
			pstI2c_data[WDR2_VMAX_1_ADDR].u32RegAddr = SC500AI_VMAX_ADDR + 1;
			pstI2c_data[WDR2_MAXSEXP_0_ADDR].u32RegAddr = SC500AI_MAXSEXP_ADDR;
			pstI2c_data[WDR2_MAXSEXP_1_ADDR].u32RegAddr = SC500AI_MAXSEXP_ADDR + 1;

			break;
		default:
			//Linear Mode Regs
			pstI2c_data[LINEAR_SHS1_0_ADDR].u32RegAddr = SC500AI_SHS1_0_ADDR;
			pstI2c_data[LINEAR_SHS1_1_ADDR].u32RegAddr = SC500AI_SHS1_1_ADDR;
			pstI2c_data[LINEAR_SHS1_2_ADDR].u32RegAddr = SC500AI_SHS1_2_ADDR;
			pstI2c_data[LINEAR_AGAIN_0_ADDR].u32RegAddr = SC500AI_AGAIN1_ADDR;
			pstI2c_data[LINEAR_AGAIN_1_ADDR].u32RegAddr = SC500AI_AGAIN1_ADDR + 1;
			pstI2c_data[LINEAR_DGAIN_0_ADDR].u32RegAddr = SC500AI_DGAIN1_ADDR;
			pstI2c_data[LINEAR_DGAIN_1_ADDR].u32RegAddr = SC500AI_DGAIN1_ADDR + 1;
			pstI2c_data[LINEAR_VMAX_0_ADDR].u32RegAddr = SC500AI_VMAX_ADDR;
			pstI2c_data[LINEAR_VMAX_1_ADDR].u32RegAddr = SC500AI_VMAX_ADDR + 1;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			...
			if (SC500AI_RES_IS_1440P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC500AI_MODE_1440P30_WDR;
			} else if (SC500AI_RES_IS_1620P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC500AI_MODE_1620P30_WDR;
			} else {
				CVI_TRACE_SNS(CVI_DBG_ERR, "Not support! Width:%d, Height:%d, Fps:%f, WDRMode:%d\n",
				       pstSensorImageMode->u16Width,
				       pstSensorImageMode->u16Height,
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &sc500ai_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_astSC500AI_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astSC500AI_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
		pstRxAttr->mipi_attr.wdr_mode = CVI_MIPI_WDR_MODE_NONE;
	} else {
		pstRxAttr->mac_clk = RX_MAC_CLK_400M;
	}
	if (pstSnsState->u8ImgMode == SC500AI_MODE_1440P30)
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &sc500ai_rx_attr;
	int i;
...
static CVI_S32 sc500ai_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunSC500AI_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, SC500AI_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, SC500AI_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, SC500AI_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16SC500AI_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16SC500AI_L2SMode[ViPipe] = pstInitAttr->enL2SMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsSC500AI_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = sc500ai_standby,
	.pfnRestart             = sc500ai_restart,
	.pfnMirrorFlip          = sc500ai_mirror_flip,
