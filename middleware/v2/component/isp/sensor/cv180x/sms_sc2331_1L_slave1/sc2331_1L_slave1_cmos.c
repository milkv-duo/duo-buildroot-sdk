...
#include "sc2331_1L_slave1_cmos_param.h"


#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define SC2331_1L_slave1_ID 0xCB5C
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastSC2331_1L_slave1[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define SC2331_1L_slave1_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastSC2331_1L_slave1[dev])
#define SC2331_1L_slave1_SENSOR_SET_CTX(dev, pstCtx)   (g_pastSC2331_1L_slave1[dev] = pstCtx)
#define SC2331_1L_slave1_SENSOR_RESET_CTX(dev)         (g_pastSC2331_1L_slave1[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunSC2331_1L_slave1_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 2},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

CVI_U16 g_au16SC2331_1L_slave1_GainMode[VI_MAX_PIPE_NUM] = {0};
CVI_U16 g_au16SC2331_1L_slave1_L2SMode[VI_MAX_PIPE_NUM] = {0};

ISP_SNS_MIRRORFLIP_TYPE_E g_aeSc2331_slave1_MirrorFip[VI_MAX_PIPE_NUM] = {0};
...
#define SC2331_1L_slave1_EXP_M_ADDR                     (0x3e01)
#define SC2331_1L_slave1_EXP_L_ADDR                     (0x3e02)

#define SC2331_1L_slave1_AGAIN_H_ADDR                   (0x3e08)

#define SC2331_1L_slave1_DGAIN_H_ADDR                   (0x3e06)
#define SC2331_1L_slave1_DGAIN_L_ADDR                   (0x3e07)

#define SC2331_1L_slave1_VMAX_H_ADDR                    (0x320e)
#define SC2331_1L_slave1_VMAX_L_ADDR                    (0x320f)

#define SC2331_1L_slave1_GAIN_DPC_ADDR                  (0x5799)
#define SC2331_1L_slave1_HOLD_ADDR                      (0x3812)
...
{
	const SC2331_1L_slave1_MODE_S *pstMode;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	CMOS_CHECK_POINTER(pstAeSnsDft);
	SC2331_1L_slave1_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);

	pstMode = &g_astSC2331_1L_slave1_mode[pstSnsState->u8ImgMode];
	pstAeSnsDft->u32FullLinesStd = pstSnsState->u32FLStd;
	pstAeSnsDft->u32FlickerFreq = 50 * 256;
	pstAeSnsDft->u32FullLinesMax = SC2331_1L_slave1_FULL_LINES_MAX;
	pstAeSnsDft->u32HmaxTimes = (1000000) / (pstSnsState->u32FLStd * 30);

	pstAeSnsDft->stIntTimeAccu.enAccuType = AE_ACCURACY_LINEAR;
	pstAeSnsDft->stIntTimeAccu.f32Accuracy = SC2331_1L_slave1_EXPACCURACY;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_astSC2331_1L_slave1_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astSC2331_1L_slave1_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astSC2331_1L_slave1_mode[pstSnsState->u8ImgMode].f32MinFps;
	...
	case SC2331_1L_slave1_MODE_1920X1080P30:
		...
		u32VMAX = (u32VMAX > SC2331_1L_slave1_FULL_LINES_MAX) ? SC2331_1L_slave1_FULL_LINES_MAX : u32VMAX;
		break;
	default:
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const SC2331_1L_slave1_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		pstSnsState->u8ImgMode = SC2331_1L_slave1_MODE_1920X1080P30;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astSC2331_1L_slave1_mode[pstSnsState->u8ImgMode].u32VtsDef;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunSC2331_1L_slave1_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = sc2331_1L_slave1_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = sc2331_1L_slave1_addr_byte;
			pstI2c_data[i].u32DataByteNum = sc2331_1L_slave1_data_byte;
		}
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (SC2331_1L_slave1_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC2331_1L_slave1_MODE_1920X1080P30;
			} else {
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	if (pstSnsState->bInit == CVI_TRUE && g_aeSc2331_slave1_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		sc2331_1L_slave1_mirror_flip(ViPipe, eSnsMirrorFlip);
		g_aeSc2331_slave1_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
}
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &sc2331_1L_slave1_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_astSC2331_1L_slave1_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astSC2331_1L_slave1_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &sc2331_1L_slave1_rx_attr;
	int i;
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = sc2331_1L_slave1_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = sc2331_1L_slave1_exit;
...
static CVI_S32 sc2331_1L_slave1_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunSC2331_1L_slave1_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	SC2331_1L_slave1_SENSOR_GET_CTX(ViPipe, pastSnsStateCtx);
	...
	SC2331_1L_slave1_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	SC2331_1L_slave1_SENSOR_RESET_CTX(ViPipe);
}
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = SC2331_1L_slave1_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, SC2331_1L_slave1_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, SC2331_1L_slave1_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, SC2331_1L_slave1_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16SC2331_1L_slave1_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16SC2331_1L_slave1_L2SMode[ViPipe] = pstInitAttr->enL2SMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsSC2331_1L_Slave1_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = sc2331_1L_slave1_standby,
	.pfnRestart             = sc2331_1L_slave1_restart,
	.pfnMirrorFlip          = sensor_mirror_flip,
	.pfnWriteReg            = sc2331_1L_slave1_write_register,
	.pfnReadReg             = sc2331_1L_slave1_read_register,
	.pfnSetBusInfo          = sc2331_1L_slave1_set_bus_info,
	...
	.pfnSnsProbe		= sc2331_1L_slave1_probe,
};
