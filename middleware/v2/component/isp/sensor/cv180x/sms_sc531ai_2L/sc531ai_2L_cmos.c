...
#include "sc531ai_2L_cmos_param.h"

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define sc531AI_2L_ID 500
#define SENSOR_sc531AI_2L_WIDTH 2880
#define SENSOR_sc531AI_2L_HEIGHT 1620
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastsc531AI_2L[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define sc531AI_2L_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastsc531AI_2L[dev])
#define sc531AI_2L_SENSOR_SET_CTX(dev, pstCtx)   (g_pastsc531AI_2L[dev] = pstCtx)
#define sc531AI_2L_SENSOR_RESET_CTX(dev)         (g_pastsc531AI_2L[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunsc531AI_2L_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

CVI_U16 g_au16sc531AI_2L_GainMode[VI_MAX_PIPE_NUM] = {0};
CVI_U16 g_au16sc531AI_2L_L2SMode[VI_MAX_PIPE_NUM] = {0};

sc531AI_2L_STATE_S g_astsc531AI_2L_State[VI_MAX_PIPE_NUM] = {{0} };
ISP_SNS_MIRRORFLIP_TYPE_E g_aeSc531ai_MirrorFip[VI_MAX_PIPE_NUM] = {0};
...
/*****sc531AI_2L Lines Range*****/
#define sc531AI_2L_FULL_LINES_MAX  (0x7FFF)

/*****sc531AI_2L Register Address*****/
#define sc531AI_2L_SHS1_0_ADDR		0x3E00
#define sc531AI_2L_SHS1_1_ADDR		0x3E01
#define sc531AI_2L_SHS1_2_ADDR		0x3E02
#define sc531AI_2L_AGAIN_ADDR		0x3E09
#define sc531AI_2L_DGAIN_ADDR		0x3E06
#define sc531AI_2L_DGAIN_FINEADDR	0x3E07
#define sc531AI_2L_FLIP_MIRROR_ADDR 0x3221
#define sc531AI_2L_VMAX_ADDR		0x320E
#define sc531AI_2L_TABLE_END		0xFFFF

#define sc531AI_2L_RES_IS_1620P(w, h)      ((w) <= 2880 && (h) <= 1620)
...
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	sc531AI_2L_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);

	pstAeSnsDft->u32FullLinesStd = pstSnsState->u32FLStd;
	pstAeSnsDft->u32FlickerFreq = 50 * 256;
	pstAeSnsDft->u32FullLinesMax = sc531AI_2L_FULL_LINES_MAX;
	...
	case WDR_MODE_NONE:   /*linear mode*/
		pstAeSnsDft->f32Fps = g_astsc531AI_2L_mode[sc531AI_2L_MODE_1620P30].f32MaxFps;
		pstAeSnsDft->f32MinFps = g_astsc531AI_2L_mode[sc531AI_2L_MODE_1620P30].f32MinFps;
		pstAeSnsDft->au8HistThresh[0] = 0xd;
		pstAeSnsDft->au8HistThresh[1] = 0x28;
		pstAeSnsDft->au8HistThresh[2] = 0x60;
		pstAeSnsDft->au8HistThresh[3] = 0x80;

		pstAeSnsDft->u32MaxAgain = g_astsc531AI_2L_mode[sc531AI_2L_MODE_1620P30].stAgain[0].u32Max;
		pstAeSnsDft->u32MinAgain = g_astsc531AI_2L_mode[sc531AI_2L_MODE_1620P30].stAgain[0].u32Min;
		pstAeSnsDft->u32MaxAgainTarget = pstAeSnsDft->u32MaxAgain;
		pstAeSnsDft->u32MinAgainTarget = pstAeSnsDft->u32MinAgain;

		pstAeSnsDft->u32MaxDgain = g_astsc531AI_2L_mode[sc531AI_2L_MODE_1620P30].stDgain[0].u32Max;
		pstAeSnsDft->u32MinDgain = g_astsc531AI_2L_mode[sc531AI_2L_MODE_1620P30].stDgain[0].u32Min;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_astsc531AI_2L_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astsc531AI_2L_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astsc531AI_2L_mode[pstSnsState->u8ImgMode].f32MinFps;

	switch (pstSnsState->u8ImgMode) {
	case sc531AI_2L_MODE_1620P30:
		...
		u32VMAX = (u32VMAX > sc531AI_2L_FULL_LINES_MAX) ? sc531AI_2L_FULL_LINES_MAX : u32VMAX;
		break;
	default:
...
static CVI_U32 Again_table[] = {
	1024, 2048, 2447, 4894, 9789, 19578, 39157, 78315
};

static CVI_U32 AgainReg[] = {
	0x00, 0x01, 0x40, 0x48, 0x49, 0x4B, 0x4F, 0x5F
};
		...
		CVI_U32 *au32IntTimeMax, CVI_U32 *au32IntTimeMin, CVI_U32 *pu32LFMaxIntTime)
{
	...
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	CVI_U32 u32MaxSexp = 2 * g_astsc531AI_2L_State[ViPipe].u32Sexp_MAX - 14;
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const sc531AI_2L_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	sc531AI_2L_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);
	pstMode = &g_astsc531AI_2L_mode[pstSnsState->u8ImgMode];
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	case WDR_MODE_NONE:
		...
		pstSnsState->u32FLStd = g_astsc531AI_2L_mode[pstSnsState->u8ImgMode].u32VtsDef;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunsc531AI_2L_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = sc531ai_2l_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = sc531ai_2l_addr_byte;
			pstI2c_data[i].u32DataByteNum = sc531ai_2l_data_byte;
		}

		//Linear Mode Regs
		pstI2c_data[LINEAR_SHS1_0_ADDR].u32RegAddr = sc531AI_2L_SHS1_0_ADDR;
		pstI2c_data[LINEAR_SHS1_1_ADDR].u32RegAddr = sc531AI_2L_SHS1_1_ADDR;
		pstI2c_data[LINEAR_SHS1_2_ADDR].u32RegAddr = sc531AI_2L_SHS1_2_ADDR;
		pstI2c_data[LINEAR_AGAIN_ADDR].u32RegAddr = sc531AI_2L_AGAIN_ADDR;
		pstI2c_data[LINEAR_DGAIN_ADDR].u32RegAddr = sc531AI_2L_DGAIN_ADDR;
		pstI2c_data[LINEAR_DGAIN_FINE_ADDR].u32RegAddr = sc531AI_2L_DGAIN_FINEADDR;
		pstI2c_data[LINEAR_FLIP_MIRROR].u32RegAddr = sc531AI_2L_FLIP_MIRROR_ADDR;
		pstI2c_data[LINEAR_VMAX_H_ADDR].u32RegAddr = sc531AI_2L_VMAX_ADDR;
		pstI2c_data[LINEAR_VMAX_L_ADDR].u32RegAddr = sc531AI_2L_VMAX_ADDR + 1;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (sc531AI_2L_RES_IS_1620P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = sc531AI_2L_MODE_1620P30;
			} else {
...
static CVI_VOID sc531ai_2l_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	if (pstSnsState->bInit == CVI_TRUE && g_aeSc531ai_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		...
		g_aeSc531ai_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
...
static CVI_VOID sensor_global_init(VI_PIPE ViPipe)
{
	...
	pstSnsState->bSyncInit = CVI_FALSE;
	pstSnsState->u8ImgMode = sc531AI_2L_MODE_1620P30;
	pstSnsState->enWDRMode = WDR_MODE_NONE;
	pstMode = &g_astsc531AI_2L_mode[pstSnsState->u8ImgMode];
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &sc531ai_2l_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_astsc531AI_2L_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astsc531AI_2L_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &sc531ai_2l_rx_attr;
	int i;
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = sc531ai_2l_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = sc531ai_2l_exit;
...
{
	g_aunsc531AI_2L_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	sc531AI_2L_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	sc531AI_2L_SENSOR_RESET_CTX(ViPipe);
}
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = sc531AI_2L_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, sc531AI_2L_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, sc531AI_2L_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, sc531AI_2L_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16sc531AI_2L_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16sc531AI_2L_L2SMode[ViPipe] = pstInitAttr->enL2SMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsSC531AI_2L_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = sc531ai_2l_standby,
	.pfnRestart             = sc531ai_2l_restart,
	.pfnMirrorFlip          = sc531ai_2l_mirror_flip,
	.pfnWriteReg            = sc531ai_2l_write_register,
	.pfnReadReg             = sc531ai_2l_read_register,
