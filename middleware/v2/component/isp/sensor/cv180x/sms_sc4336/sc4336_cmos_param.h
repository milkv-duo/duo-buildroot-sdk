#ifndef __SC4336_CMOS_PARAM_H_
#define __SC4336_CMOS_PARAM_H_
...
static const SC4336_MODE_S g_astSC4336_mode[SC4336_MODE_NUM] = {
	[SC4336_MODE_1440P30] = {
		.name = "1440p30",
		.astImg[0] = {
			.stSnsSize = {
...
struct combo_dev_attr_s sc4336_rx_attr = {
