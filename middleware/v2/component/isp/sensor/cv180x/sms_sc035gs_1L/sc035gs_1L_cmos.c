...
#include "sc035gs_1L_cmos_param.h"

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define SC035GS_1L_ID 35
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastSC035GS_1L[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define SC035GS_1L_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastSC035GS_1L[dev])
#define SC035GS_1L_SENSOR_SET_CTX(dev, pstCtx)   (g_pastSC035GS_1L[dev] = pstCtx)
#define SC035GS_1L_SENSOR_RESET_CTX(dev)         (g_pastSC035GS_1L[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunSC035GS_1L_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 2},
...
/*****SC035GS_1L Lines Range*****/
#define SC035GS_1L_FULL_LINES_MAX  (0xFFFF)

/*****SC035GS_1L Register Address*****/
#define SC035GS_1L_EXP_H_ADDR                     (0x3e01)
#define SC035GS_1L_EXP_L_ADDR                     (0x3e02)

#define SC035GS_1L_AGAIN_H_ADDR                   (0x3e08)
#define SC035GS_1L_AGAIN_L_ADDR                   (0x3e09)

#define SC035GS_1L_DGAIN_H_ADDR                   (0x3e06)
#define SC035GS_1L_DGAIN_L_ADDR                   (0x3e07)

#define SC035GS_1L_VMAX_H_ADDR                    (0x320e)
#define SC035GS_1L_VMAX_L_ADDR                    (0x320f)

#define SC035GS_1L_GAIN_MAGIC_0_ADDR              (0x3314)
#define SC035GS_1L_GAIN_MAGIC_1_ADDR              (0x3317)

#define SC035GS_1L_RES_IS_480P(w, h)      ((w) == 640 && (h) == 480)

static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	const SC035GS_1L_MODE_S *pstMode;
	...
	pstMode = &g_astSC035GS_1L_mode[pstSnsState->u8ImgMode];
#if 0
	memset(&pstAeSnsDft->stAERouteAttr, 0, sizeof(ISP_AE_ROUTE_S));
#endif
	pstAeSnsDft->u32FullLinesStd = pstSnsState->u32FLStd;
	pstAeSnsDft->u32FlickerFreq = 50 * 256;
	pstAeSnsDft->u32FullLinesMax = SC035GS_1L_FULL_LINES_MAX;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_astSC035GS_1L_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astSC035GS_1L_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astSC035GS_1L_mode[pstSnsState->u8ImgMode].f32MinFps;

	switch (pstSnsState->u8ImgMode) {
	case SC035GS_1L_MODE_640X480P120:
		...
		u32VMAX = (u32VMAX > SC035GS_1L_FULL_LINES_MAX) ? SC035GS_1L_FULL_LINES_MAX : u32VMAX;
		break;
	default:
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const SC035GS_1L_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		pstSnsState->u8ImgMode = SC035GS_1L_MODE_640X480P120;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astSC035GS_1L_mode[pstSnsState->u8ImgMode].u32VtsDef;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunSC035GS_1L_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = sc035gs_1L_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = sc035gs_1L_addr_byte;
			pstI2c_data[i].u32DataByteNum = sc035gs_1L_data_byte;
		}

		switch (pstSnsState->enWDRMode) {
		case WDR_MODE_NONE:
			//Linear Mode Regs
			pstI2c_data[LINEAR_EXP_H_ADDR].u32RegAddr = SC035GS_1L_EXP_H_ADDR;
			pstI2c_data[LINEAR_EXP_L_ADDR].u32RegAddr = SC035GS_1L_EXP_L_ADDR;
			pstI2c_data[LINEAR_AGAIN_H_ADDR].u32RegAddr = SC035GS_1L_AGAIN_H_ADDR;
			pstI2c_data[LINEAR_AGAIN_L_ADDR].u32RegAddr = SC035GS_1L_AGAIN_L_ADDR;
			pstI2c_data[LINEAR_DGAIN_H_ADDR].u32RegAddr = SC035GS_1L_DGAIN_H_ADDR;
			pstI2c_data[LINEAR_DGAIN_L_ADDR].u32RegAddr = SC035GS_1L_DGAIN_L_ADDR;
			pstI2c_data[LINEAR_VMAX_H_ADDR].u32RegAddr = SC035GS_1L_VMAX_H_ADDR;
			pstI2c_data[LINEAR_VMAX_L_ADDR].u32RegAddr = SC035GS_1L_VMAX_L_ADDR;
			pstI2c_data[LINEAR_GAIN_MAGIC_0_ADDR].bUpdate = CVI_FALSE;
			pstI2c_data[LINEAR_GAIN_MAGIC_0_ADDR].u32RegAddr = SC035GS_1L_GAIN_MAGIC_0_ADDR;
			pstI2c_data[LINEAR_GAIN_MAGIC_1_ADDR].bUpdate = CVI_FALSE;
			pstI2c_data[LINEAR_GAIN_MAGIC_1_ADDR].u32RegAddr = SC035GS_1L_GAIN_MAGIC_1_ADDR;
			break;
		default:
			CVI_TRACE_SNS(CVI_DBG_ERR, "Not support WDR: %d\n", pstSnsState->enWDRMode);
			return CVI_FAILURE;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 120) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (SC035GS_1L_RES_IS_480P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC035GS_1L_MODE_640X480P120;
			} else {
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &sc035gs_1L_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_astSC035GS_1L_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astSC035GS_1L_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &sc035gs_1L_rx_attr;
	int i;
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = sc035gs_1L_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = sc035gs_1L_exit;
...
static CVI_S32 sc035gs_1L_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunSC035GS_1L_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	SC035GS_1L_SENSOR_GET_CTX(ViPipe, pastSnsStateCtx);
	...
	SC035GS_1L_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	SC035GS_1L_SENSOR_RESET_CTX(ViPipe);
}
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = SC035GS_1L_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, SC035GS_1L_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, SC035GS_1L_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, SC035GS_1L_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16SC035GS_1L_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16SC035GS_1L_L2SMode[ViPipe] = pstInitAttr->enL2SMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsSC035GS_1L_Obj = {
