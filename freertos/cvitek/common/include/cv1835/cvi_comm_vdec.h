...
/*********************************************************************************************/
/* invlalid channel ID */
#define CVI_ERR_VDEC_INVALID_CHNID CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_CHNID)
/* at lease one parameter is illagal ,eg, an illegal enumeration value  */
#define CVI_ERR_VDEC_ILLEGAL_PARAM CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
/* channel exists */
#define CVI_ERR_VDEC_EXIST CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_EXIST)
/* using a NULL point */
#define CVI_ERR_VDEC_NULL_PTR CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
/* try to enable or initialize system,device or channel, before configing attribute */
#define CVI_ERR_VDEC_NOT_CONFIG CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_CONFIG)
/* operation is not supported by NOW */
#define CVI_ERR_VDEC_NOT_SUPPORT CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
/* operation is not permitted ,eg, try to change stati attribute */
#define CVI_ERR_VDEC_NOT_PERM CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
/* the channel is not existed  */
#define CVI_ERR_VDEC_UNEXIST CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_UNEXIST)
/* failure caused by malloc memory */
#define CVI_ERR_VDEC_NOMEM CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_NOMEM)
/* failure caused by malloc buffer */
#define CVI_ERR_VDEC_NOBUF CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_NOBUF)
/* no data in buffer */
#define CVI_ERR_VDEC_BUF_EMPTY CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_EMPTY)
/* no buffer for new data */
#define CVI_ERR_VDEC_BUF_FULL CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_FULL)
/* system is not ready,had not initialed or loaded */
#define CVI_ERR_VDEC_SYS_NOTREADY CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
/* system busy */
#define CVI_ERR_VDEC_BUSY CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_BUSY)

/* bad address,  eg. used for copy_from_user & copy_to_user   */
#define CVI_ERR_VDEC_BADADDR CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_BADADDR)
