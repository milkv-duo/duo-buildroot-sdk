...
int v4l2_ctrl_query_fill(struct v4l2_queryctrl *qctrl, s32 min, s32 max,
			 s32 step, s32 def);
...
struct v4l2_subdev *v4l2_i2c_new_subdev(struct v4l2_device *v4l2_dev,
					...
					const char *client_type, u8 addr,
 ...
 * returns a &struct v4l2_subdev pointer.
 */
struct v4l2_subdev *v4l2_i2c_new_subdev_board(
	struct v4l2_device *v4l2_dev, struct i2c_adapter *adapter,
 ...
 */
const unsigned short *v4l2_i2c_tuner_addrs(enum v4l2_i2c_tuner_type tuner_type);
...
v4l2_find_nearest_format(const struct v4l2_discrete_probe *probe, s32 width,
			 s32 height);
