...
#ifndef __CVI_DEFINES_H__
#define __CVI_DEFINES_H__
...
#define CVI1835_Vxxx 0x18350000
#ifndef CVICHIP
#define CVICHIP CVI1835_Vxxx
#endif

#ifndef CVI_CHIP_NAME
#define CVI_CHIP_NAME "CV1835"
#endif
...
#define IS_CHIP_CV183X(x) (((x) == CVI1835) || ((x) == CVI1832) || ((x) == CVI1838) || ((x) == CVI1829))
#define IS_CHIP_CV182X(x) (((x) == CVI1822) || ((x) == CVI1826))
...
#define VPSS_MAX_IMAGE_WIDTH            4608
