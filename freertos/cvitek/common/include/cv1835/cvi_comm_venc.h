...
enum VENC_STATUS_CODE_E {
	STAT_INIT = 64,
	STAT_FRC_NO_ENC,
	ERR_EMPTY_STREAM_FRAME,
	ERR_EMPTY_PACK,
	ERR_BUTT,
};
...
#define CVI_VENC_PERF(msg, ...)		\
	do { \
		...
		CVI_TRACE(CVI_DBG_NOTICE, CVI_ID_VENC, "%s:%d:%s()[PERF]: "msg, \
		__FILENAME__, __LINE__, __func__, ##__VA_ARGS__); \
	} while (0)
...
/// Invalid channel ID
#define CVI_ERR_VENC_INVALID_CHNID CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_CHNID)
/* at least one parameter is illagal ,eg, an illegal enumeration value  */
#define CVI_ERR_VENC_ILLEGAL_PARAM CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
/* channel exists */
#define CVI_ERR_VENC_EXIST CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_EXIST)
/// The channel doesn't exist.
#define CVI_ERR_VENC_UNEXIST CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_UNEXIST)
/* using a NULL point */
#define CVI_ERR_VENC_NULL_PTR CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
// try to enable or initialize system,device or channel, before configing attribute
#define CVI_ERR_VENC_NOT_CONFIG CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_CONFIG)
/// The operation is not supported
#define CVI_ERR_VENC_NOT_SUPPORT CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
/* operation is not permitted ,eg, try to change stati attribute */
#define CVI_ERR_VENC_NOT_PERM CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
/// Memory allocation failed
#define CVI_ERR_VENC_NOMEM CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NOMEM)
/// Buffer allocation failed
#define CVI_ERR_VENC_NOBUF CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NOBUF)
/* no data in buffer */
#define CVI_ERR_VENC_BUF_EMPTY CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_EMPTY)
/* no buffer for new data */
#define CVI_ERR_VENC_BUF_FULL CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_FULL)
/* system is not ready, had not initialized or loaded */
#define CVI_ERR_VENC_SYS_NOTREADY CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
/// The device is busy
#define CVI_ERR_VENC_BUSY CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_BUSY)
#define CVI_ERR_VENC_INIT CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_INFO, STAT_INIT)
#define CVI_ERR_VENC_FRC_NO_ENC CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_INFO, STAT_FRC_NO_ENC)
#define CVI_ERR_VENC_EMPTY_STREAM_FRAME CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_INFO, ERR_EMPTY_STREAM_FRAME)
#define CVI_ERR_VENC_EMPTY_PACK CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_INFO, ERR_EMPTY_PACK)
...
typedef struct _VENC_ATTR_JPEG_S {
	...
	CVI_BOOL bSingleEsBuf; /* Use single es buffer*/
} VENC_ATTR_JPEG_S;
