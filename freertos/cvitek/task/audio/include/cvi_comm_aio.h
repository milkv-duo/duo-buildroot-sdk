...
} AI_AEC_CONFIG_S __attribute__((packed)) __attribute__((aligned(0x8)));
...
} AUDIO_DELAY_CONFIG_S __attribute__((packed)) __attribute__((aligned(0x8)));
...
} AUDIO_AGC_CONFIG_S __attribute__((packed)) __attribute__((aligned(0x8)));
...
} AUDIO_ANR_CONFIG_S __attribute__((packed)) __attribute__((aligned(0x8)));
...
} AI_TALKVQE_CONFIG_S __attribute__((packed)) __attribute__((aligned(0x8)));
