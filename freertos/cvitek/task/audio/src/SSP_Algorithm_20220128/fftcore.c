/************************************************************************** * */ 
/* FFT implementation minus cosine transforms, minus all but radix 2/4 case
 *  We only need this cut-down version. To do more than just power-of-two sized vectors
 *
 *  Note that the packing is a little strange; rather than the FFT r/i
 *  packing following R_0, I_0, R_1, I_1, R_2, I_2 ... R_n-1, I_n-1,
 *  it follows R_0, R_1, I_1, R_2, I_2 ... R_n-1, I_n-1, R_n */ 
/************************************************************************** *  */
