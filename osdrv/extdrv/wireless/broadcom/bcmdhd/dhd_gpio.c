...
#ifdef CUSTOMER_HW_CVITEK
		cvi_sdio_rescan(); /* Request MMC to do rescan again */
#endif /* CUSTOMER_HW_CVITEK */
#elif defined(BCMPCIE)
...
int dhd_wlan_init_gpio(void)
{
	...
	*/
...
#endif
	{
		gpio_wl_reg_on = -1;
#ifdef CUSTOMER_HW_CVITEK
		gpio_wl_reg_on = cvi_get_wifi_pwr_on_gpio();
#endif /* CUSTOMER_HW_CVITEK */
#ifdef CUSTOMER_OOB
		gpio_wl_host_wake = -1;
#ifdef CUSTOMER_HW_CVITEK
		gpio_wl_host_wake = cvi_get_wifi_wakeup_gpio();
#endif /* CUSTOMER_HW_CVITEK */
#endif
	}
