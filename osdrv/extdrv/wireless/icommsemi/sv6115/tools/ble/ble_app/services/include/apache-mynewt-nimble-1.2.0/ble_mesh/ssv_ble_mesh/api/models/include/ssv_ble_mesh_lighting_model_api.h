...
#ifndef _SSV_BLE_MESH_LIGHTING_MODEL_API_H_
#define _SSV_BLE_MESH_LIGHTING_MODEL_API_H_

#include "ssv_ble_mesh_defs.h"

/** @def    SSV_BLE_MESH_MODEL_LIGHT_LIGHTNESS_CLI
 *
 ...
 */
#define SSV_BLE_MESH_MODEL_LIGHT_LIGHTNESS_CLI(cli_pub, cli_data)           \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_LIGHTNESS_CLI,   \
                    NULL, cli_pub, cli_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_CTL_CLI
 *
 ...
 */
#define SSV_BLE_MESH_MODEL_LIGHT_CTL_CLI(cli_pub, cli_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_CTL_CLI,     \
                    NULL, cli_pub, cli_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_HSL_CLI
 *
 ...
 */
#define SSV_BLE_MESH_MODEL_LIGHT_HSL_CLI(cli_pub, cli_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_HSL_CLI,     \
                    NULL, cli_pub, cli_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_XYL_CLI
 *
 ...
 */
#define SSV_BLE_MESH_MODEL_LIGHT_XYL_CLI(cli_pub, cli_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_XYL_CLI,     \
                    NULL, cli_pub, cli_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_LC_CLI
 *
 ...
 */
#define SSV_BLE_MESH_MODEL_LIGHT_LC_CLI(cli_pub, cli_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_LC_CLI,     \
                    NULL, cli_pub, cli_data)
...
} ssv_ble_mesh_light_lightness_set_t;
...
} ssv_ble_mesh_light_lightness_range_set_t;
...
typedef struct {
    ...
    uint8_t  trans_time;       /*!< Time to complete state transition (optional) */
    uint8_t  delay;            /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_light_ctl_temperature_set_t;
...
} ssv_ble_mesh_light_ctl_temperature_range_set_t;
...
} ssv_ble_mesh_light_ctl_default_set_t;
...
typedef struct {
    ...
    uint8_t  trans_time;       /*!< Time to complete state transition (optional) */
    uint8_t  delay;            /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_light_hsl_hue_set_t;
...
typedef struct {
    ...
    uint8_t  trans_time;       /*!< Time to complete state transition (optional) */
    uint8_t  delay;            /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_light_hsl_saturation_set_t;
...
} ssv_ble_mesh_light_hsl_default_set_t;
...
} ssv_ble_mesh_light_hsl_range_set_t;
...
} ssv_ble_mesh_light_xyl_default_set_t;
...
typedef struct {
    ...
    uint8_t trans_time;        /*!< Time to complete state transition (optional) */
    uint8_t delay;             /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_light_lc_light_onoff_set_t;

/** Parameter of Light LC Property Get */
typedef struct {
    uint16_t property_id;      /*!< Property ID identifying a Light LC Property */
} ssv_ble_mesh_light_lc_property_get_t;

/** Parameters of Light LC Property Set */
typedef struct {
    uint16_t property_id;      /*!< Property ID identifying a Light LC Property */
    struct net_buf_simple *property_value;  /*!< Raw value for the Light LC Property */
} ssv_ble_mesh_light_lc_property_set_t;

/**
 * @brief Lighting Client Model get message union
 */
typedef union {
    ssv_ble_mesh_light_lc_property_get_t           lc_property_get;             /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LC_PROPERTY_GET */
} ssv_ble_mesh_light_client_get_state_t;

/**
 * @brief Lighting Client Model set message union
 */
typedef union {
    ssv_ble_mesh_light_lightness_set_t             lightness_set;               /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_SET_UNACK */
    ssv_ble_mesh_light_lightness_linear_set_t      lightness_linear_set;        /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_LINEAR_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_LINEAR_SET_UNACK */
    ssv_ble_mesh_light_lightness_default_set_t     lightness_default_set;       /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_DEFAULT_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_DEFAULT_SET_UNACK */
    ssv_ble_mesh_light_lightness_range_set_t       lightness_range_set;         /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_RANGE_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_RANGE_SET_UNACK */
    ssv_ble_mesh_light_ctl_set_t                   ctl_set;                     /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_CTL_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_CTL_SET_UNACK */
    ssv_ble_mesh_light_ctl_temperature_set_t       ctl_temperature_set;         /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_CTL_TEMPERATURE_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_CTL_TEMPERATURE_SET_UNACK */
    ssv_ble_mesh_light_ctl_temperature_range_set_t ctl_temperature_range_set;   /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_CTL_TEMPERATURE_RANGE_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_CTL_TEMPERATURE_RANGE_SET_UNACK */
    ssv_ble_mesh_light_ctl_default_set_t           ctl_default_set;             /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_CTL_DEFAULT_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_CTL_DEFAULT_SET_UNACK */
    ssv_ble_mesh_light_hsl_set_t                   hsl_set;                     /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_SET_UNACK */
    ssv_ble_mesh_light_hsl_hue_set_t               hsl_hue_set;                 /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_HUE_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_HUE_SET_UNACK */
    ssv_ble_mesh_light_hsl_saturation_set_t        hsl_saturation_set;          /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_SATURATION_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_SATURATION_SET_UNACK */
    ssv_ble_mesh_light_hsl_default_set_t           hsl_default_set;             /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_DEFAULT_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_DEFAULT_SET_UNACK */
    ssv_ble_mesh_light_hsl_range_set_t             hsl_range_set;               /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_RANGE_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_RANGE_SET_UNACK */
    ssv_ble_mesh_light_xyl_set_t                   xyl_set;                     /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_XYL_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_XYL_SET_UNACK */
    ssv_ble_mesh_light_xyl_default_set_t           xyl_default_set;             /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_XYL_DEFAULT_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_XYL_DEFAULT_SET_UNACK */
    ssv_ble_mesh_light_xyl_range_set_t             xyl_range_set;               /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_XYL_RANGE_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_XYL_RANGE_SET_UNACK */
    ssv_ble_mesh_light_lc_mode_set_t               lc_mode_set;                 /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LC_MODE_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_LC_MODE_SET_UNACK */
    ssv_ble_mesh_light_lc_om_set_t                 lc_om_set;                   /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LC_OM_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_LC_OM_SET_UNACK */
    ssv_ble_mesh_light_lc_light_onoff_set_t        lc_light_onoff_set;          /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LC_LIGHT_ONOFF_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_LC_LIGHT_ONOFF_SET_UNACK */
    ssv_ble_mesh_light_lc_property_set_t           lc_property_set;             /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LC_PROPERTY_SET & SSV_BLE_MESH_MODEL_OP_LIGHT_LC_PROPERTY_SET_UNACK */
} ssv_ble_mesh_light_client_set_state_t;
...
} ssv_ble_mesh_light_lightness_status_cb_t;
...
typedef struct {
    ...
    uint16_t range_min;            /*!< Value of range min field of light lightness range state */
    uint16_t range_max;            /*!< Value of range max field of light lightness range state */
} ssv_ble_mesh_light_lightness_range_status_cb_t;
...
typedef struct {
    ...
    uint8_t  remain_time;              /*!< Time to complete state transition (C.1) */
} ssv_ble_mesh_light_ctl_status_cb_t;
...
typedef struct {
    ...
    uint8_t  remain_time;              /*!< Time to complete state transition (C.1) */
} ssv_ble_mesh_light_ctl_temperature_status_cb_t;
...
typedef struct {
    ...
    uint16_t range_min;        /*!< Value of temperature range min field of light ctl temperature range state */
    uint16_t range_max;        /*!< Value of temperature range max field of light ctl temperature range state */
} ssv_ble_mesh_light_ctl_temperature_range_status_cb_t;
...
typedef struct {
    ...
    uint16_t temperature;      /*!< Value of light temperature default state */
    int16_t  delta_uv;         /*!< Value of light delta UV default state */
} ssv_ble_mesh_light_ctl_default_status_cb_t;
...
} ssv_ble_mesh_light_hsl_status_cb_t;
...
typedef struct {
    ...
    uint8_t  remain_time;              /*!< Time to complete state transition (optional) */
} ssv_ble_mesh_light_hsl_target_status_cb_t;
...
typedef struct {
    ...
    uint8_t  remain_time;  /*!< Time to complete state transition (C.1) */
} ssv_ble_mesh_light_hsl_hue_status_cb_t;
...
typedef struct {
    ...
    uint8_t  remain_time;          /*!< Time to complete state transition (C.1) */
} ssv_ble_mesh_light_hsl_saturation_status_cb_t;
...
typedef struct {
    ...
    uint16_t hue;          /*!< Value of light hue default state */
    uint16_t saturation;   /*!< Value of light saturation default state */
} ssv_ble_mesh_light_hsl_default_status_cb_t;
...
typedef struct {
    ...
    uint16_t saturation_range_min; /*!< Value of saturation range min field of light hsl saturation range state */
    uint16_t saturation_range_max; /*!< Value of saturation range max field of light hsl saturation range state */
} ssv_ble_mesh_light_hsl_range_status_cb_t;
...
typedef struct {
    ...
    uint8_t  remain_time;          /*!< Time to complete state transition (optional) */
} ssv_ble_mesh_light_xyl_status_cb_t;
...
typedef struct {
    ...
    uint8_t  remain_time;          /*!< Time to complete state transition (optional) */
} ssv_ble_mesh_light_xyl_target_status_cb_t;
...
typedef struct {
    ...
    uint16_t xyl_x;            /*!< The value of the Light xyL x Default state */
    uint16_t xyl_y;            /*!< The value of the Light xyL y Default state */
} ssv_ble_mesh_light_xyl_default_status_cb_t;
...
typedef struct {
    ...
    uint8_t remain_time;           /*!< Time to complete state transition (C.1) */
} ssv_ble_mesh_light_lc_light_onoff_status_cb_t;

/** Parameters of Light LC Property Status */
typedef struct {
    uint16_t property_id;      /*!< Property ID identifying a Light LC Property */
    struct net_buf_simple *property_value;  /*!< Raw value for the Light LC Property */
} ssv_ble_mesh_light_lc_property_status_cb_t;

/**
 * @brief Lighting Client Model received message union
 */
typedef union {
    ssv_ble_mesh_light_lightness_status_cb_t             lightness_status;             /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_STATUS */
    ssv_ble_mesh_light_lightness_linear_status_cb_t      lightness_linear_status;      /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_LINEAR_STATUS */
    ssv_ble_mesh_light_lightness_last_status_cb_t        lightness_last_status;        /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_LAST_STATUS */
    ssv_ble_mesh_light_lightness_default_status_cb_t     lightness_default_status;     /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_DEFAULT_STATUS */
    ssv_ble_mesh_light_lightness_range_status_cb_t       lightness_range_status;       /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_RANGE_STATUS */
    ssv_ble_mesh_light_ctl_status_cb_t                   ctl_status;                   /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_CTL_STATUS */
    ssv_ble_mesh_light_ctl_temperature_status_cb_t       ctl_temperature_status;       /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_CTL_TEMPERATURE_STATUS */
    ssv_ble_mesh_light_ctl_temperature_range_status_cb_t ctl_temperature_range_status; /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_CTL_TEMPERATURE_RANGE_STATUS */
    ssv_ble_mesh_light_ctl_default_status_cb_t           ctl_default_status;           /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_CTL_DEFAULT_STATUS */
    ssv_ble_mesh_light_hsl_status_cb_t                   hsl_status;                   /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_STATUS */
    ssv_ble_mesh_light_hsl_target_status_cb_t            hsl_target_status;            /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_TARGET_STATUS */
    ssv_ble_mesh_light_hsl_hue_status_cb_t               hsl_hue_status;               /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_HUE_STATUS */
    ssv_ble_mesh_light_hsl_saturation_status_cb_t        hsl_saturation_status;        /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_SATURATION_STATUS */
    ssv_ble_mesh_light_hsl_default_status_cb_t           hsl_default_status;           /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_DEFAULT_STATUS */
    ssv_ble_mesh_light_hsl_range_status_cb_t             hsl_range_status;             /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_HSL_RANGE_STATUS */
    ssv_ble_mesh_light_xyl_status_cb_t                   xyl_status;                   /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_XYL_STATUS */
    ssv_ble_mesh_light_xyl_target_status_cb_t            xyl_target_status;            /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_XYL_TARGET_STATUS */
    ssv_ble_mesh_light_xyl_default_status_cb_t           xyl_default_status;           /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_XYL_DEFAULT_STATUS */
    ssv_ble_mesh_light_xyl_range_status_cb_t             xyl_range_status;             /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_XYL_RANGE_STATUS */
    ssv_ble_mesh_light_lc_mode_status_cb_t               lc_mode_status;               /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LC_MODE_STATUS */
    ssv_ble_mesh_light_lc_om_status_cb_t                 lc_om_status;                 /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LC_OM_STATUS */
    ssv_ble_mesh_light_lc_light_onoff_status_cb_t        lc_light_onoff_status;        /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LC_LIGHT_ONOFF_STATUS */
    ssv_ble_mesh_light_lc_property_status_cb_t           lc_property_status;           /*!< For SSV_BLE_MESH_MODEL_OP_LIGHT_LC_PROPERTY_STATUS */
} ssv_ble_mesh_light_client_status_cb_t;
...
typedef struct {
    ...
    ssv_ble_mesh_light_client_status_cb_t status_cb;    /*!< The light status message callback values */
} ssv_ble_mesh_light_client_cb_param_t;

/** This enum value is the event of Lighting Client Model */
typedef enum {
    SSV_BLE_MESH_LIGHT_CLIENT_GET_STATE_EVT,
    SSV_BLE_MESH_LIGHT_CLIENT_SET_STATE_EVT,
    SSV_BLE_MESH_LIGHT_CLIENT_PUBLISH_EVT,
    SSV_BLE_MESH_LIGHT_CLIENT_TIMEOUT_EVT,
    SSV_BLE_MESH_LIGHT_CLIENT_EVT_MAX,
} ssv_ble_mesh_light_client_cb_event_t;
 ...
 */
typedef void (* ssv_ble_mesh_light_client_cb_t)(ssv_ble_mesh_light_client_cb_event_t event,
        ssv_ble_mesh_light_client_cb_param_t *param);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_register_light_client_callback(ssv_ble_mesh_light_client_cb_t callback);
 ...
 *              please refer to ssv_ble_mesh_light_message_opcode_t in ssv_ble_mesh_defs.h
 *
 ...
 *
 */
ssv_err_t ssv_ble_mesh_light_client_get_state(ssv_ble_mesh_client_common_param_t *params,
        ssv_ble_mesh_light_client_get_state_t *get_state);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_light_client_set_state(ssv_ble_mesh_client_common_param_t *params,
        ssv_ble_mesh_light_client_set_state_t *set_state);

/**
 * @brief Lighting Server Models related context.
 */

/** @def    SSV_BLE_MESH_MODEL_LIGHT_LIGHTNESS_SRV
 *
 ...
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_lightness_srv_t.
 *
 *  @return New Light Lightness Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_LIGHTNESS_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_LIGHTNESS_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_LIGHTNESS_SETUP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_lightness_setup_srv_t.
 *
 *  @return New Light Lightness Setup Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_LIGHTNESS_SETUP_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_LIGHTNESS_SETUP_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_CTL_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_ctl_srv_t.
 *
 *  @return New Light CTL Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_CTL_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_CTL_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_CTL_SETUP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_ctl_setup_srv_t.
 *
 *  @return New Light CTL Setup Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_CTL_SETUP_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_CTL_SETUP_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_CTL_TEMP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_ctl_temp_srv_t.
 *
 *  @return New Light CTL Temperature Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_CTL_TEMP_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_CTL_TEMP_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_HSL_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_hsl_srv_t.
 *
 *  @return New Light HSL Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_HSL_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_HSL_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_HSL_SETUP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_hsl_setup_srv_t.
 *
 *  @return New Light HSL Setup Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_HSL_SETUP_SRV(srv_pub, srv_data)           \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_HSL_SETUP_SRV,   \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_HSL_HUE_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_hsl_hue_srv_t.
 *
 *  @return New Light HSL Hue Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_HSL_HUE_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_HSL_HUE_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_HSL_SAT_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_hsl_sat_srv_t.
 *
 *  @return New Light HSL Saturation Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_HSL_SAT_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_HSL_SAT_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_XYL_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_xyl_srv_t.
 *
 *  @return New Light xyL Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_XYL_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_XYL_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_XYL_SETUP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_xyl_setup_srv_t.
 *
 *  @return New Light xyL Setup Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_XYL_SETUP_SRV(srv_pub, srv_data)           \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_XYL_SETUP_SRV,   \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_LC_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_lc_srv_t.
 *
 *  @return New Light LC Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_LC_SRV(srv_pub, srv_data)           \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_LC_SRV,   \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_LIGHT_LC_SETUP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_light_lc_setup_srv_t.
 *
 *  @return New Light LC Setup Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_LIGHT_LC_SETUP_SRV(srv_pub, srv_data)           \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_LIGHT_LC_SETUP_SRV,   \
                    NULL, srv_pub, srv_data)
...
} ssv_ble_mesh_light_lightness_state_t;

/** User data of Light Lightness Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                    /*!< Pointer to the Lighting Lightness Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_lightness_state_t *state;    /*!< Parameters of the Light Lightness state */
    ssv_ble_mesh_last_msg_info_t last;              /*!< Parameters of the last received set message */
    ssv_ble_mesh_state_transition_t actual_transition;  /*!< Parameters of state transition */
    ssv_ble_mesh_state_transition_t linear_transition;  /*!< Parameters of state transition */
...
} ssv_ble_mesh_light_lightness_srv_t;

/** User data of Light Lightness Setup Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                    /*!< Pointer to the Lighting Lightness Setup Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_lightness_state_t *state;    /*!< Parameters of the Light Lightness state */
} ssv_ble_mesh_light_lightness_setup_srv_t;
...
} ssv_ble_mesh_light_ctl_state_t;

/** User data of Light CTL Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Lighting CTL Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_ctl_state_t *state;      /*!< Parameters of the Light CTL state */
    ssv_ble_mesh_last_msg_info_t last;          /*!< Parameters of the last received set message */
    ssv_ble_mesh_state_transition_t transition; /*!< Parameters of state transition */
...
} ssv_ble_mesh_light_ctl_srv_t;

/** User data of Light CTL Setup Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Lighting CTL Setup Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_ctl_state_t *state;      /*!< Parameters of the Light CTL state */
} ssv_ble_mesh_light_ctl_setup_srv_t;

/** User data of Light CTL Temperature Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Lighting CTL Temperature Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_ctl_state_t *state;      /*!< Parameters of the Light CTL state */
    ssv_ble_mesh_last_msg_info_t last;          /*!< Parameters of the last received set message */
    ssv_ble_mesh_state_transition_t transition; /*!< Parameters of state transition */
    int32_t tt_delta_temperature;   /*!< Delta change value of temperature state transition */
    int32_t tt_delta_delta_uv;      /*!< Delta change value of delta uv state transition */
} ssv_ble_mesh_light_ctl_temp_srv_t;
...
} ssv_ble_mesh_light_hsl_state_t;

/** User data of Light HSL Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Lighting HSL Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_hsl_state_t *state;      /*!< Parameters of the Light HSL state */
    ssv_ble_mesh_last_msg_info_t last;          /*!< Parameters of the last received set message */
    ssv_ble_mesh_state_transition_t transition; /*!< Parameters of state transition */
    int32_t tt_delta_lightness;     /*!< Delta change value of lightness state transition */
...
} ssv_ble_mesh_light_hsl_srv_t;

/** User data of Light HSL Setup Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Lighting HSL Setup Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_hsl_state_t *state;      /*!< Parameters of the Light HSL state */
} ssv_ble_mesh_light_hsl_setup_srv_t;

/** User data of Light HSL Hue Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Lighting HSL Hue Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_hsl_state_t *state;      /*!< Parameters of the Light HSL state */
    ssv_ble_mesh_last_msg_info_t last;          /*!< Parameters of the last received set message */
    ssv_ble_mesh_state_transition_t transition; /*!< Parameters of state transition */
    int32_t tt_delta_hue;   /*!< Delta change value of hue state transition */
} ssv_ble_mesh_light_hsl_hue_srv_t;

/** User data of Light HSL Saturation Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;    /*!< Pointer to the Lighting HSL Saturation Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_hsl_state_t *state;      /*!< Parameters of the Light HSL state */
    ssv_ble_mesh_last_msg_info_t last;          /*!< Parameters of the last received set message */
    ssv_ble_mesh_state_transition_t transition; /*!< Parameters of state transition */
    int32_t tt_delta_saturation;    /*!< Delta change value of saturation state transition */
} ssv_ble_mesh_light_hsl_sat_srv_t;
...
} ssv_ble_mesh_light_xyl_state_t;

/** User data of Light xyL Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Lighting xyL Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_xyl_state_t *state;      /*!< Parameters of the Light xyL state */
    ssv_ble_mesh_last_msg_info_t last;          /*!< Parameters of the last received set message */
    ssv_ble_mesh_state_transition_t transition; /*!< Parameters of state transition */
    int32_t tt_delta_lightness; /*!< Delta change value of lightness state transition */
    int32_t tt_delta_x;         /*!< Delta change value of x state transition */
    int32_t tt_delta_y;         /*!< Delta change value of y state transition */
} ssv_ble_mesh_light_xyl_srv_t;

/** User data of Light xyL Setup Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Lighting xyL Setup Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_xyl_state_t *state;      /*!< Parameters of the Light xyL state */
} ssv_ble_mesh_light_xyl_setup_srv_t;
...
} ssv_ble_mesh_light_lc_property_state_t;

/** This enum value is the Light LC State Machine states */
typedef enum {
    SSV_BLE_MESH_LC_OFF,
    SSV_BLE_MESH_LC_STANDBY,
    SSV_BLE_MESH_LC_FADE_ON,
    SSV_BLE_MESH_LC_RUN,
    SSV_BLE_MESH_LC_FADE,
    SSV_BLE_MESH_LC_PROLONG,
    SSV_BLE_MESH_LC_FADE_STANDBY_AUTO,
    SSV_BLE_MESH_LC_FADE_STANDBY_MANUAL,
} ssv_ble_mesh_lc_state_t;
...
typedef struct {
    ...
    ssv_ble_mesh_lc_state_t state;      /*!< The value of Light LC state machine state */
    struct k_delayed_work timer;        /*!< Timer of Light LC state machine */
} ssv_ble_mesh_light_lc_state_machine_t;

/** Parameters of Light Lightness controller */
typedef struct {
    ssv_ble_mesh_light_lc_state_t          state;           /*!< Parameters of Light LC state */
    ssv_ble_mesh_light_lc_property_state_t prop_state;      /*!< Parameters of Light LC Property state */
    ssv_ble_mesh_light_lc_state_machine_t  state_machine;   /*!< Parameters of Light LC state machine */
} ssv_ble_mesh_light_control_t;

/** User data of Light LC Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Lighting LC Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_control_t *lc;           /*!< Parameters of the Light controller */
    ssv_ble_mesh_last_msg_info_t last;          /*!< Parameters of the last received set message */
    ssv_ble_mesh_state_transition_t transition; /*!< Parameters of state transition */
} ssv_ble_mesh_light_lc_srv_t;

/** User data of Light LC Setup Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Lighting LC Setup Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_light_control_t *lc;           /*!< Parameters of the Light controller */
} ssv_ble_mesh_light_lc_setup_srv_t;

/** Parameter of Light Lightness Actual state change event */
typedef struct {
    uint16_t lightness;     /*!< The value of Light Lightness Actual state */
} ssv_ble_mesh_state_change_light_lightness_set_t;

/** Parameter of Light Lightness Linear state change event */
typedef struct {
    uint16_t lightness;     /*!< The value of Light Lightness Linear state */
} ssv_ble_mesh_state_change_light_lightness_linear_set_t;

/** Parameter of Light Lightness Default state change event */
typedef struct {
    uint16_t lightness;     /*!< The value of Light Lightness Default state */
} ssv_ble_mesh_state_change_light_lightness_default_set_t;
...
} ssv_ble_mesh_state_change_light_lightness_range_set_t;
...
} ssv_ble_mesh_state_change_light_ctl_set_t;

/** Parameters of Light CTL Temperature state change event */
typedef struct {
    uint16_t temperature;   /*!< The value of Light CTL Temperature state */
    int16_t  delta_uv;      /*!< The value of Light CTL Delta UV state */
} ssv_ble_mesh_state_change_light_ctl_temperature_set_t;
...
} ssv_ble_mesh_state_change_light_ctl_temperature_range_set_t;
...
} ssv_ble_mesh_state_change_light_ctl_default_set_t;
...
} ssv_ble_mesh_state_change_light_hsl_set_t;

/** Parameter of Light HSL Hue state change event */
typedef struct {
    uint16_t hue;           /*!< The value of Light HSL Hue state */
} ssv_ble_mesh_state_change_light_hsl_hue_set_t;

/** Parameter of Light HSL Saturation state change event */
typedef struct {
    uint16_t saturation;    /*!< The value of Light HSL Saturation state */
} ssv_ble_mesh_state_change_light_hsl_saturation_set_t;
...
} ssv_ble_mesh_state_change_light_hsl_default_set_t;
...
} ssv_ble_mesh_state_change_light_hsl_range_set_t;
...
} ssv_ble_mesh_state_change_light_xyl_set_t;
...
} ssv_ble_mesh_state_change_light_xyl_default_set_t;
...
} ssv_ble_mesh_state_change_light_lc_property_set_t;
...
} ssv_ble_mesh_state_change_sensor_status_t;
...
typedef union {
     ...
     */
    ssv_ble_mesh_state_change_light_lightness_set_t             lightness_set;          /*!< Light Lightness Set */
    ssv_ble_mesh_state_change_light_lightness_linear_set_t      lightness_linear_set;   /*!< Light Lightness Linear Set */
    ssv_ble_mesh_state_change_light_lightness_default_set_t     lightness_default_set;  /*!< Light Lightness Default Set */
    ssv_ble_mesh_state_change_light_lightness_range_set_t       lightness_range_set;    /*!< Light Lightness Range Set */
    ssv_ble_mesh_state_change_light_ctl_set_t                   ctl_set;                /*!< Light CTL Set */
    ssv_ble_mesh_state_change_light_ctl_temperature_set_t       ctl_temp_set;           /*!< Light CTL Temperature Set */
    ssv_ble_mesh_state_change_light_ctl_temperature_range_set_t ctl_temp_range_set;     /*!< Light CTL Temperature Range Set */
    ssv_ble_mesh_state_change_light_ctl_default_set_t           ctl_default_set;        /*!< Light CTL Default Set */
    ssv_ble_mesh_state_change_light_hsl_set_t                   hsl_set;                /*!< Light HSL Set */
    ssv_ble_mesh_state_change_light_hsl_hue_set_t               hsl_hue_set;            /*!< Light HSL Hue Set */
    ssv_ble_mesh_state_change_light_hsl_saturation_set_t        hsl_saturation_set;     /*!< Light HSL Saturation Set */
    ssv_ble_mesh_state_change_light_hsl_default_set_t           hsl_default_set;        /*!< Light HSL Default Set */
    ssv_ble_mesh_state_change_light_hsl_range_set_t             hsl_range_set;          /*!< Light HSL Range Set */
    ssv_ble_mesh_state_change_light_xyl_set_t                   xyl_set;                /*!< Light xyL Set */
    ssv_ble_mesh_state_change_light_xyl_default_set_t           xyl_default_set;        /*!< Light xyL Default Set */
    ssv_ble_mesh_state_change_light_xyl_range_set_t             xyl_range_set;          /*!< Light xyL Range Set */
    ssv_ble_mesh_state_change_light_lc_mode_set_t               lc_mode_set;            /*!< Light LC Mode Set */
    ssv_ble_mesh_state_change_light_lc_om_set_t                 lc_om_set;              /*!< Light LC Occupancy Mode Set */
    ssv_ble_mesh_state_change_light_lc_light_onoff_set_t        lc_light_onoff_set;     /*!< Light LC Light OnOff Set */
    ssv_ble_mesh_state_change_light_lc_property_set_t           lc_property_set;        /*!< Light LC Property Set */
    ssv_ble_mesh_state_change_sensor_status_t                   sensor_status;          /*!< Sensor Status */
} ssv_ble_mesh_lighting_server_state_change_t;

/** Context of the received Light LC Property Get message */
typedef struct {
    uint16_t property_id;   /*!< Property ID identifying a Light LC Property */
} ssv_ble_mesh_server_recv_light_lc_property_get_t;

/**
 * @brief Lighting Server Model received get message union
 */
typedef union {
    ssv_ble_mesh_server_recv_light_lc_property_get_t lc_property;   /*!< Light LC Property Get */
} ssv_ble_mesh_lighting_server_recv_get_msg_t;
...
typedef struct {
    ...
    uint8_t  trans_time;    /*!< Time to complete state transition (optional) */
    uint8_t  delay;         /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_server_recv_light_lightness_set_t;
...
typedef struct {
    ...
    uint8_t  trans_time;    /*!< Time to complete state transition (optional) */
    uint8_t  delay;         /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_server_recv_light_lightness_linear_set_t;

/** Context of the received Light Lightness Default Set message */
typedef struct {
    uint16_t lightness;     /*!< The value of the Light Lightness Default state */
} ssv_ble_mesh_server_recv_light_lightness_default_set_t;

/** Context of the received Light Lightness Range Set message */
typedef struct {
    uint16_t range_min;     /*!< Value of range min field of light lightness range state */
    uint16_t range_max;     /*!< Value of range max field of light lightness range state */
} ssv_ble_mesh_server_recv_light_lightness_range_set_t;
...
typedef struct {
    ...
    uint8_t  trans_time;    /*!< Time to complete state transition (optional) */
    uint8_t  delay;         /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_server_recv_light_ctl_set_t;
...
typedef struct {
    ...
    uint8_t  trans_time;    /*!< Time to complete state transition (optional) */
    uint8_t  delay;         /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_server_recv_light_ctl_temperature_set_t;

/** Context of the received Light CTL Temperature Range Set message */
typedef struct {
    uint16_t range_min;     /*!< Value of temperature range min field of light ctl temperature range state */
    uint16_t range_max;     /*!< Value of temperature range max field of light ctl temperature range state */
} ssv_ble_mesh_server_recv_light_ctl_temperature_range_set_t;
...
typedef struct {
    ...
    uint16_t temperature;   /*!< Value of light temperature default state */
    int16_t  delta_uv;      /*!< Value of light delta UV default state */
} ssv_ble_mesh_server_recv_light_ctl_default_set_t;
...
typedef struct {
    ...
    uint8_t  trans_time;    /*!< Time to complete state transition (optional) */
    uint8_t  delay;         /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_server_recv_light_hsl_set_t;
...
typedef struct {
    ...
    uint8_t  trans_time;    /*!< Time to complete state transition (optional) */
    uint8_t  delay;         /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_server_recv_light_hsl_hue_set_t;
...
typedef struct {
    ...
    uint8_t  trans_time;    /*!< Time to complete state transition (optional) */
    uint8_t  delay;         /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_server_recv_light_hsl_saturation_set_t;
...
typedef struct {
    ...
    uint16_t hue;           /*!< Value of light hue default state */
    uint16_t saturation;    /*!< Value of light saturation default state */
} ssv_ble_mesh_server_recv_light_hsl_default_set_t;
...
typedef struct {
    ...
    uint16_t saturation_range_min;  /*!< Value of saturation range min field of light hsl saturation range state */
    uint16_t saturation_range_max;  /*!< Value of saturation range max field of light hsl saturation range state */
} ssv_ble_mesh_server_recv_light_hsl_range_set_t;
...
typedef struct {
    ...
    uint8_t  trans_time;    /*!< Time to complete state transition (optional) */
    uint8_t  delay;         /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_server_recv_light_xyl_set_t;
...
} ssv_ble_mesh_server_recv_light_xyl_default_set_t;
...
} ssv_ble_mesh_server_recv_light_xyl_range_set_t;

/** Context of the received Light LC Mode Set message */
typedef struct {
    uint8_t mode;   /*!< The target value of the Light LC Mode state */
} ssv_ble_mesh_server_recv_light_lc_mode_set_t;

/** Context of the received Light OM Set message */
typedef struct {
    uint8_t mode;   /*!< The target value of the Light LC Occupancy Mode state */
} ssv_ble_mesh_server_recv_light_lc_om_set_t;
...
typedef struct {
    ...
    uint8_t trans_time;     /*!< Time to complete state transition (optional) */
    uint8_t delay;          /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_server_recv_light_lc_light_onoff_set_t;

/** Context of the received Light LC Property Set message */
typedef struct {
    uint16_t property_id;   /*!< Property ID identifying a Light LC Property */
    struct net_buf_simple *property_value;  /*!< Raw value for the Light LC Property */
} ssv_ble_mesh_server_recv_light_lc_property_set_t;

/**
 * @brief Lighting Server Model received set message union
 */
typedef union {
    ssv_ble_mesh_server_recv_light_lightness_set_t             lightness;           /*!< Light Lightness Set/Light Lightness Set Unack */
    ssv_ble_mesh_server_recv_light_lightness_linear_set_t      lightness_linear;    /*!< Light Lightness Linear Set/Light Lightness Linear Set Unack */
    ssv_ble_mesh_server_recv_light_lightness_default_set_t     lightness_default;   /*!< Light Lightness Default Set/Light Lightness Default Set Unack */
    ssv_ble_mesh_server_recv_light_lightness_range_set_t       lightness_range;     /*!< Light Lightness Range Set/Light Lightness Range Set Unack */
    ssv_ble_mesh_server_recv_light_ctl_set_t                   ctl;                 /*!< Light CTL Set/Light CTL Set Unack */
    ssv_ble_mesh_server_recv_light_ctl_temperature_set_t       ctl_temp;            /*!< Light CTL Temperature Set/Light CTL Temperature Set Unack */
    ssv_ble_mesh_server_recv_light_ctl_temperature_range_set_t ctl_temp_range;      /*!< Light CTL Temperature Range Set/Light CTL Temperature Range Set Unack */
    ssv_ble_mesh_server_recv_light_ctl_default_set_t           ctl_default;         /*!< Light CTL Default Set/Light CTL Default Set Unack */
    ssv_ble_mesh_server_recv_light_hsl_set_t                   hsl;                 /*!< Light HSL Set/Light HSL Set Unack */
    ssv_ble_mesh_server_recv_light_hsl_hue_set_t               hsl_hue;             /*!< Light HSL Hue Set/Light HSL Hue Set Unack */
    ssv_ble_mesh_server_recv_light_hsl_saturation_set_t        hsl_saturation;      /*!< Light HSL Saturation Set/Light HSL Saturation Set Unack */
    ssv_ble_mesh_server_recv_light_hsl_default_set_t           hsl_default;         /*!< Light HSL Default Set/Light HSL Default Set Unack */
    ssv_ble_mesh_server_recv_light_hsl_range_set_t             hsl_range;           /*!< Light HSL Range Set/Light HSL Range Set Unack */
    ssv_ble_mesh_server_recv_light_xyl_set_t                   xyl;                 /*!< Light xyL Set/Light xyL Set Unack */
    ssv_ble_mesh_server_recv_light_xyl_default_set_t           xyl_default;         /*!< Light xyL Default Set/Light xyL Default Set Unack */
    ssv_ble_mesh_server_recv_light_xyl_range_set_t             xyl_range;           /*!< Light xyL Range Set/Light xyL Range Set Unack */
    ssv_ble_mesh_server_recv_light_lc_mode_set_t               lc_mode;             /*!< Light LC Mode Set/Light LC Mode Set Unack */
    ssv_ble_mesh_server_recv_light_lc_om_set_t                 lc_om;               /*!< Light LC OM Set/Light LC OM Set Unack */
    ssv_ble_mesh_server_recv_light_lc_light_onoff_set_t        lc_light_onoff;      /*!< Light LC Light OnOff Set/Light LC Light OnOff Set Unack */
    ssv_ble_mesh_server_recv_light_lc_property_set_t           lc_property;         /*!< Light LC Property Set/Light LC Property Set Unack */
} ssv_ble_mesh_lighting_server_recv_set_msg_t;

/** Context of the received Sensor Status message */
typedef struct {
    struct net_buf_simple *data;    /*!< Value of sensor data state (optional) */
} ssv_ble_mesh_server_recv_sensor_status_t;

/**
 * @brief Lighting Server Model received status message union
 */
typedef union {
    ssv_ble_mesh_server_recv_sensor_status_t sensor_status;     /*!< Sensor Status */
} ssv_ble_mesh_lighting_server_recv_status_msg_t;

/**
 * @brief Lighting Server Model callback value union
 */
typedef union {
    ssv_ble_mesh_lighting_server_state_change_t state_change;   /*!< SSV_BLE_MESH_LIGHTING_SERVER_STATE_CHANGE_EVT */
    ssv_ble_mesh_lighting_server_recv_get_msg_t get;            /*!< SSV_BLE_MESH_LIGHTING_SERVER_RECV_GET_MSG_EVT */
    ssv_ble_mesh_lighting_server_recv_set_msg_t set;            /*!< SSV_BLE_MESH_LIGHTING_SERVER_RECV_SET_MSG_EVT */
    ssv_ble_mesh_lighting_server_recv_status_msg_t status;      /*!< SSV_BLE_MESH_LIGHTING_SERVER_RECV_STATUS_MSG_EVT */
} ssv_ble_mesh_lighting_server_cb_value_t;

/** Lighting Server Model callback parameters */
typedef struct {
    ssv_ble_mesh_model_t  *model;   /*!< Pointer to Lighting Server Models */
    ssv_ble_mesh_msg_ctx_t ctx;     /*!< Context of the received messages */
    ssv_ble_mesh_lighting_server_cb_value_t value;  /*!< Value of the received Lighting Messages */
} ssv_ble_mesh_lighting_server_cb_param_t;
...
typedef enum {
     ...
     *    are received.
     */
    SSV_BLE_MESH_LIGHTING_SERVER_STATE_CHANGE_EVT,
    /**
     * When get_auto_rsp is set to SSV_BLE_MESH_SERVER_RSP_BY_APP, this event will be
     * callback to the application layer when Lighting Get messages are received.
     */
    SSV_BLE_MESH_LIGHTING_SERVER_RECV_GET_MSG_EVT,
    /**
     ...
     */
    SSV_BLE_MESH_LIGHTING_SERVER_RECV_SET_MSG_EVT,
    /**
     * When status_auto_rsp is set to SSV_BLE_MESH_SERVER_RSP_BY_APP, this event will
     * be callback to the application layer when Sensor Status message is received.
     */
    SSV_BLE_MESH_LIGHTING_SERVER_RECV_STATUS_MSG_EVT,
    SSV_BLE_MESH_LIGHTING_SERVER_EVT_MAX,
} ssv_ble_mesh_lighting_server_cb_event_t;
 ...
 * @param   param: Pointer to callback parameter
 */
typedef void (* ssv_ble_mesh_lighting_server_cb_t)(ssv_ble_mesh_lighting_server_cb_event_t event,
        ssv_ble_mesh_lighting_server_cb_param_t *param);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_register_lighting_server_callback(ssv_ble_mesh_lighting_server_cb_t callback);

#endif /* _SSV_BLE_MESH_LIGHTING_MODEL_API_H_ */
