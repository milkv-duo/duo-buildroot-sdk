...
#ifndef _SSV_BLE_MESH_LOW_POWER_API_H_
#define _SSV_BLE_MESH_LOW_POWER_API_H_
 ...
 *
 */
ssv_err_t ssv_ble_mesh_lpn_enable(void);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_lpn_disable(bool force);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_lpn_poll(void);

#endif /* _SSV_BLE_MESH_LOW_POWER_API_H_ */
