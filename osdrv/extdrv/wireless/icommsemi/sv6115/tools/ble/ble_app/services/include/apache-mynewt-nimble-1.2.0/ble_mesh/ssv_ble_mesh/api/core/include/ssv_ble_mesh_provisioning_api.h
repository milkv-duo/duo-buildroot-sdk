...
#ifndef _SSV_BLE_MESH_PROVISIONING_API_H_
#define _SSV_BLE_MESH_PROVISIONING_API_H_

#include "ssv_ble_mesh_defs.h"

/** @brief: event, event code of provisioning events; param, parameters of provisioning events */
typedef void (* ssv_ble_mesh_prov_cb_t)(ssv_ble_mesh_prov_cb_event_t event,
                                        ssv_ble_mesh_prov_cb_param_t *param);
 ...
 *
 * @note         This is intended to be called if the user has received SSV_BLE_MESH_NODE_PROV_INPUT_EVT
 *               with SSV_BLE_MESH_ENTER_NUMBER as the action.
 *
 ...
 *
 * @note         This is intended to be called if the user has received SSV_BLE_MESH_NODE_PROV_INPUT_EVT
 *               with SSV_BLE_MESH_ENTER_STRING as the action.
 *
 ...
 * @brief        Provide provisioning input OOB string.
 *
 *               This is intended to be called after the ssv_ble_mesh_prov_t prov_input_num
 *               callback has been called with SSV_BLE_MESH_ENTER_STRING as the action.
 *
 ...
 *
 *               This is intended to be called after the ssv_ble_mesh_prov_t prov_input_num
 *               callback has been called with SSV_BLE_MESH_ENTER_NUMBER as the action.
 *
 ...
 *                    SSV_BLE_MESH_PROV_ADV and SSV_BLE_MESH_PROV_GATT enabled, and cannot set flags
 ...
 *                  ssv_ble_mesh_register_prov_callback. And in the callback, the Provisioner
 ...
 *                    device address can be added, bearers shall be set with SSV_BLE_MESH_PROV_ADV
 ...
 *                    address need to be added, bearers shall be set with SSV_BLE_MESH_PROV_GATT enabled,
 ...
 *                    of SSV_BLE_MESH_PROV_ADV and SSV_BLE_MESH_PROV_GATT enabled (recommend to enable the
 ...
 *                  - Note: SSV_BLE_MESH_PROV_ADV, SSV_BLE_MESH_PROV_GATT and ADD_DEV_START_PROV_NOW_FLAG
 ...
 *
 */
typedef void (*ssv_ble_mesh_prov_adv_cb_t)(const ssv_ble_mesh_bd_addr_t addr, const ssv_ble_mesh_addr_type_t addr_type,
        const uint8_t adv_type, const uint8_t *dev_uuid,
        uint16_t oob_info, ssv_ble_mesh_prov_bearer_t bearer);
...
#endif /* _SSV_BLE_MESH_PROVISIONING_API_H_ */
