...
#ifndef _SSV_FAST_PROV_CLIENT_MODEL_H
#define _SSV_FAST_PROV_CLIENT_MODEL_H
...
ssv_err_t example_fast_prov_client_recv_timeout(uint32_t opcode, ssv_ble_mesh_model_t *model,
        ssv_ble_mesh_msg_ctx_t *ctx);

ssv_err_t example_fast_prov_client_recv_status(ssv_ble_mesh_model_t *model,
        ssv_ble_mesh_msg_ctx_t *ctx,
        uint16_t len, const uint8_t *data);

#endif /* _SSV_FAST_PROV_CLIENT_MODEL_H */