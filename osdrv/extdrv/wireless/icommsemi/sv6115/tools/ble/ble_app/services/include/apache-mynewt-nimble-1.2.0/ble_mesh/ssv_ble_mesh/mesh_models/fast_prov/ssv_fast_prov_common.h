...
#ifndef _SSV_FAST_PROV_COMMON_H
#define _SSV_FAST_PROV_COMMON_H
...
/* Fast Prov Model ID */
#define SSV_BLE_MESH_VND_MODEL_ID_FAST_PROV_CLI                 0x0000
#define SSV_BLE_MESH_VND_MODEL_ID_FAST_PROV_SRV                 0x0001

/* Fast Prov Message Opcode */
#define SSV_BLE_MESH_VND_MODEL_OP_FAST_PROV_INFO_SET            SSV_BLE_MESH_MODEL_OP_3(0x00, CID_ESP)
#define SSV_BLE_MESH_VND_MODEL_OP_FAST_PROV_INFO_STATUS         SSV_BLE_MESH_MODEL_OP_3(0x01, CID_ESP)

#define SSV_BLE_MESH_VND_MODEL_OP_FAST_PROV_NET_KEY_ADD         SSV_BLE_MESH_MODEL_OP_3(0x02, CID_ESP)
#define SSV_BLE_MESH_VND_MODEL_OP_FAST_PROV_NET_KEY_STATUS      SSV_BLE_MESH_MODEL_OP_3(0x03, CID_ESP)

#define SSV_BLE_MESH_VND_MODEL_OP_FAST_PROV_NODE_ADDR           SSV_BLE_MESH_MODEL_OP_3(0x04, CID_ESP)
#define SSV_BLE_MESH_VND_MODEL_OP_FAST_PROV_NODE_ADDR_ACK       SSV_BLE_MESH_MODEL_OP_3(0x05, CID_ESP)

#define SSV_BLE_MESH_VND_MODEL_OP_FAST_PROV_NODE_ADDR_GET       SSV_BLE_MESH_MODEL_OP_3(0x06, CID_ESP)
#define SSV_BLE_MESH_VND_MODEL_OP_FAST_PROV_NODE_ADDR_STATUS    SSV_BLE_MESH_MODEL_OP_3(0x07, CID_ESP)

#define SSV_BLE_MESH_VND_MODEL_OP_FAST_PROV_NODE_GROUP_ADD      SSV_BLE_MESH_MODEL_OP_3(0x08, CID_ESP)

#define SSV_BLE_MESH_VND_MODEL_OP_FAST_PROV_NODE_GROUP_DELETE   SSV_BLE_MESH_MODEL_OP_3(0x09, CID_ESP)
