...
#define BTA_DM_BLE_GAP_SET_EXT_ADV_PROP_LEGACY_IND        (SSV_BLE_GAP_SET_EXT_ADV_PROP_LEGACY |\
                                                            SSV_BLE_GAP_SET_EXT_ADV_PROP_CONNECTABLE |\
                                                            SSV_BLE_GAP_SET_EXT_ADV_PROP_SCANNABLE)
#define BTA_DM_BLE_GAP_SET_EXT_ADV_PROP_LEGACY_LD_DIR     (SSV_BLE_GAP_SET_EXT_ADV_PROP_LEGACY |\
                                                            SSV_BLE_GAP_SET_EXT_ADV_PROP_CONNECTABLE |\
                                                            SSV_BLE_GAP_SET_EXT_ADV_PROP_DIRECTED)
#define BTA_DM_BLE_GAP_SET_EXT_ADV_PROP_LEGACY_HD_DIR     (SSV_BLE_GAP_SET_EXT_ADV_PROP_LEGACY |\
                                                            SSV_BLE_GAP_SET_EXT_ADV_PROP_CONNECTABLE |\
                                                            SSV_BLE_GAP_SET_EXT_ADV_PROP_HD_DIRECTED)
#define BTA_DM_BLE_GAP_SET_EXT_ADV_PROP_LEGACY_SCAN       (SSV_BLE_GAP_SET_EXT_ADV_PROP_LEGACY |\
                                                            SSV_BLE_GAP_SET_EXT_ADV_PROP_SCANNABLE)
#define BTA_DM_BLE_GAP_SET_EXT_ADV_PROP_LEGACY_NONCONN    (SSV_BLE_GAP_SET_EXT_ADV_PROP_LEGACY)
