...
#ifndef _SSV_BLE_MESH_TIME_SCENE_MODEL_API_H_
#define _SSV_BLE_MESH_TIME_SCENE_MODEL_API_H_

#include "ssv_ble_mesh_defs.h"

/** @def    SSV_BLE_MESH_MODEL_TIME_CLI
 *
 ...
 */
#define SSV_BLE_MESH_MODEL_TIME_CLI(cli_pub, cli_data)         \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_TIME_CLI, \
                    NULL, cli_pub, cli_data)

/** @def    SSV_BLE_MESH_MODEL_SCENE_CLI
 *
 ...
 */
#define SSV_BLE_MESH_MODEL_SCENE_CLI(cli_pub, cli_data)         \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_SCENE_CLI, \
                    NULL, cli_pub, cli_data)

/** @def    SSV_BLE_MESH_MODEL_SCHEDULER_CLI
 *
 ...
 */
#define SSV_BLE_MESH_MODEL_SCHEDULER_CLI(cli_pub, cli_data)         \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_SCHEDULER_CLI, \
                    NULL, cli_pub, cli_data)
...
} ssv_ble_mesh_scheduler_act_set_t;

/**
 * @brief Time Scene Client Model get message union
 */
typedef union {
    ssv_ble_mesh_scheduler_act_get_t scheduler_act_get; /*!< For SSV_BLE_MESH_MODEL_OP_SCHEDULER_ACT_GET */
} ssv_ble_mesh_time_scene_client_get_state_t;

/**
 * @brief Time Scene Client Model set message union
 */
typedef union {
    ssv_ble_mesh_time_set_t          time_set;          /*!< For SSV_BLE_MESH_MODEL_OP_TIME_SET */
    ssv_ble_mesh_time_zone_set_t     time_zone_set;     /*!< For SSV_BLE_MESH_MODEL_OP_TIME_ZONE_SET */
    ssv_ble_mesh_tai_utc_delta_set_t tai_utc_delta_set; /*!< For SSV_BLE_MESH_MODEL_OP_TAI_UTC_DELTA_SET */
    ssv_ble_mesh_time_role_set_t     time_role_set;     /*!< For SSV_BLE_MESH_MODEL_OP_TIME_ROLE_SET */
    ssv_ble_mesh_scene_store_t       scene_store;       /*!< For SSV_BLE_MESH_MODEL_OP_SCENE_STORE & SSV_BLE_MESH_MODEL_OP_SCENE_STORE_UNACK */
    ssv_ble_mesh_scene_recall_t      scene_recall;      /*!< For SSV_BLE_MESH_MODEL_OP_SCENE_RECALL & SSV_BLE_MESH_MODEL_OP_SCENE_RECALL_UNACK */
    ssv_ble_mesh_scene_delete_t      scene_delete;      /*!< For SSV_BLE_MESH_MODEL_OP_SCENE_DELETE & SSV_BLE_MESH_MODEL_OP_SCENE_DELETE_UNACK */
    ssv_ble_mesh_scheduler_act_set_t scheduler_act_set; /*!< For SSV_BLE_MESH_MODEL_OP_SCHEDULER_ACT_SET & SSV_BLE_MESH_MODEL_OP_SCHEDULER_ACT_SET_UNACK */
} ssv_ble_mesh_time_scene_client_set_state_t;
...
typedef struct {
    ...
    uint8_t time_zone_offset_new;      /*!< Upcoming local time zone offset */
    uint8_t tai_zone_change[5];        /*!< TAI Seconds time of the upcoming Time Zone Offset change */
} ssv_ble_mesh_time_zone_status_cb_t;
...
typedef struct {
    ...
    uint8_t tai_delta_change[5];       /*!< TAI Seconds time of the upcoming TAI-UTC Delta change */
} ssv_ble_mesh_tai_utc_delta_status_cb_t;

/** Parameter of Time Role Status */
typedef struct {
    uint8_t time_role;  /*!< The Time Role for the element */
} ssv_ble_mesh_time_role_status_cb_t;
...
} ssv_ble_mesh_scene_status_cb_t;
...
typedef struct {
    ...
    uint64_t trans_time : 8;    /*!< Transition time for this action */
    uint16_t scene_number;      /*!< Transition time for this action */
} ssv_ble_mesh_scheduler_act_status_cb_t;

/**
 * @brief Time Scene Client Model received message union
 */
typedef union {
    ssv_ble_mesh_time_status_cb_t           time_status;            /*!< For SSV_BLE_MESH_MODEL_OP_TIME_STATUS */
    ssv_ble_mesh_time_zone_status_cb_t      time_zone_status;       /*!< For SSV_BLE_MESH_MODEL_OP_TIME_ZONE_STATUS */
    ssv_ble_mesh_tai_utc_delta_status_cb_t  tai_utc_delta_status;   /*!< For SSV_BLE_MESH_MODEL_OP_TAI_UTC_DELTA_STATUS */
    ssv_ble_mesh_time_role_status_cb_t      time_role_status;       /*!< For SSV_BLE_MESH_MODEL_OP_TIME_ROLE_STATUS */
    ssv_ble_mesh_scene_status_cb_t          scene_status;           /*!< For SSV_BLE_MESH_MODEL_OP_SCENE_STATUS */
    ssv_ble_mesh_scene_register_status_cb_t scene_register_status;  /*!< For SSV_BLE_MESH_MODEL_OP_SCENE_REGISTER_STATUS */
    ssv_ble_mesh_scheduler_status_cb_t      scheduler_status;       /*!< For SSV_BLE_MESH_MODEL_OP_SCHEDULER_STATUS */
    ssv_ble_mesh_scheduler_act_status_cb_t  scheduler_act_status;   /*!< For SSV_BLE_MESH_MODEL_OP_SCHEDULER_ACT_STATUS */
} ssv_ble_mesh_time_scene_client_status_cb_t;
...
typedef struct {
    ...
    ssv_ble_mesh_time_scene_client_status_cb_t status_cb;   /*!< The scene status message callback values */
} ssv_ble_mesh_time_scene_client_cb_param_t;

/** This enum value is the event of Time Scene Client Model */
typedef enum {
    SSV_BLE_MESH_TIME_SCENE_CLIENT_GET_STATE_EVT,
    SSV_BLE_MESH_TIME_SCENE_CLIENT_SET_STATE_EVT,
    SSV_BLE_MESH_TIME_SCENE_CLIENT_PUBLISH_EVT,
    SSV_BLE_MESH_TIME_SCENE_CLIENT_TIMEOUT_EVT,
    SSV_BLE_MESH_TIME_SCENE_CLIENT_EVT_MAX,
} ssv_ble_mesh_time_scene_client_cb_event_t;
 ...
 */
typedef void (* ssv_ble_mesh_time_scene_client_cb_t)(ssv_ble_mesh_time_scene_client_cb_event_t event,
        ssv_ble_mesh_time_scene_client_cb_param_t *param);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_register_time_scene_client_callback(ssv_ble_mesh_time_scene_client_cb_t callback);
 ...
 *              please refer to ssv_ble_mesh_time_scene_message_opcode_t in ssv_ble_mesh_defs.h
 *
 ...
 * @return      SSV_BM_OK on success or error code otherwise.
 */
ssv_err_t ssv_ble_mesh_time_scene_client_get_state(ssv_ble_mesh_client_common_param_t *params,
        ssv_ble_mesh_time_scene_client_get_state_t *get_state);
 ...
 * @return      SSV_BM_OK on success or error code otherwise.
 */
ssv_err_t ssv_ble_mesh_time_scene_client_set_state(ssv_ble_mesh_client_common_param_t *params,
        ssv_ble_mesh_time_scene_client_set_state_t *set_state);

/**
 * @brief Time Scene Server Models related context.
 */

/** @def    SSV_BLE_MESH_MODEL_TIME_SRV
 *
 ...
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_time_srv_t.
 *
 *  @return New Time Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_TIME_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_TIME_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_TIME_SETUP_SRV
 *
 ...
 *
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_time_setup_srv_t.
 *
 *  @return New Time Setup Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_TIME_SETUP_SRV(srv_data)                     \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_TIME_SETUP_SRV,    \
                    NULL, NULL, srv_data)

/** @def    SSV_BLE_MESH_MODEL_SCENE_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_scene_srv_t.
 *
 *  @return New Scene Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_SCENE_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_SCENE_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_SCENE_SETUP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_scene_setup_srv_t.
 *
 *  @return New Scene Setup Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_SCENE_SETUP_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_SCENE_SETUP_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_SCHEDULER_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_scheduler_srv_t.
 *
 *  @return New Scheduler Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_SCHEDULER_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_SCHEDULER_SRV,     \
                    NULL, srv_pub, srv_data)

/** @def    SSV_BLE_MESH_MODEL_SCHEDULER_SETUP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct ssv_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct ssv_ble_mesh_scheduler_setup_srv_t.
 *
 *  @return New Scheduler Setup Server Model instance.
 */
#define SSV_BLE_MESH_MODEL_SCHEDULER_SETUP_SRV(srv_pub, srv_data)             \
        SSV_BLE_MESH_SIG_MODEL(SSV_BLE_MESH_MODEL_ID_SCHEDULER_SETUP_SRV,     \
                    NULL, srv_pub, srv_data)

#define SSV_BLE_MESH_UNKNOWN_TAI_SECONDS        0x0000000000    /*!< Unknown TAI Seconds */
#define SSV_BLE_MESH_UNKNOWN_TAI_ZONE_CHANGE    0x0000000000    /*!< Unknown TAI of Zone Change */
#define SSV_BLE_MESH_UNKNOWN_TAI_DELTA_CHANGE   0x0000000000    /*!< Unknown TAI of Delta Change */

#define SSV_BLE_MESH_TAI_UTC_DELAT_MAX_VALUE    0x7FFF  /*!< Maximum TAI-UTC Delta value */

#define SSV_BLE_MESH_TAI_SECONDS_LEN            0x05    /*!< Length of TAI Seconds */
#define SSV_BLE_MESH_TAI_OF_ZONE_CHANGE_LEN     0x05    /*!< Length of TAI of Zone Change */
#define SSV_BLE_MESH_TAI_OF_DELAT_CHANGE_LEN    0x05    /*!< Length of TAI of Delta Change */

#define SSV_BLE_MESH_INVALID_SCENE_NUMBER       0x0000  /*!< Invalid Scene Number */
#define SSV_BLE_MESH_SCENE_NUMBER_LEN           0x02    /*!< Length of the Scene Number */

#define SSV_BLE_MESH_SCHEDULE_YEAR_ANY_YEAR     0x64    /*!< Any year of the Scheduled year */

#define SSV_BLE_MESH_SCHEDULE_DAY_ANY_DAY       0x00    /*!< Any day of the Scheduled day */

#define SSV_BLE_MESH_SCHEDULE_HOUR_ANY_HOUR     0x18    /*!< Any hour of the Scheduled hour */
#define SSV_BLE_MESH_SCHEDULE_HOUR_ONCE_A_DAY   0x19    /*!< Any hour of the Scheduled Day */

#define SSV_BLE_MESH_SCHEDULE_SEC_ANY_OF_HOUR   0x3C    /*!< Any minute of the Scheduled hour */
#define SSV_BLE_MESH_SCHEDULE_SEC_EVERY_15_MIN  0x3D    /*!< Every 15 minutes of the Scheduled hour */
#define SSV_BLE_MESH_SCHEDULE_SEC_EVERY_20_MIN  0x3E    /*!< Every 20 minutes of the Scheduled hour */
#define SSV_BLE_MESH_SCHEDULE_SEC_ONCE_AN_HOUR  0x3F    /*!< Once of the Scheduled hour */

#define SSV_BLE_MESH_SCHEDULE_SEC_ANY_OF_MIN    0x3C    /*!< Any second of the Scheduled minute */
#define SSV_BLE_MESH_SCHEDULE_SEC_EVERY_15_SEC  0x3D    /*!< Every 15 seconds of the Scheduled minute */
#define SSV_BLE_MESH_SCHEDULE_SEC_EVERY_20_SEC  0x3E    /*!< Every 20 seconds of the Scheduled minute */
#define SSV_BLE_MESH_SCHEDULE_SEC_ONCE_AN_MIN   0x3F    /*!< Once of the Scheduled minute */

#define SSV_BLE_MESH_SCHEDULE_ACT_TURN_OFF      0x00    /*!< Scheduled Action - Turn Off */
#define SSV_BLE_MESH_SCHEDULE_ACT_TURN_ON       0x01    /*!< Scheduled Action - Turn On */
#define SSV_BLE_MESH_SCHEDULE_ACT_SCENE_RECALL  0x02    /*!< Scheduled Action - Scene Recall */
#define SSV_BLE_MESH_SCHEDULE_ACT_NO_ACTION     0x0F    /*!< Scheduled Action - No Action */

#define SSV_BLE_MESH_SCHEDULE_SCENE_NO_SCENE    0x0000  /*!< Scheduled Scene - No Scene */

#define SSV_BLE_MESH_SCHEDULE_ENTRY_MAX_INDEX   0x0F    /*!< Maximum number of Scheduled entries */

#define SSV_BLE_MESH_TIME_NONE          0x00    /*!< Time Role - None */
#define SSV_BLE_MESH_TIME_AUTHORITY     0x01    /*!< Time Role - Mesh Time Authority */
#define SSV_BLE_MESH_TIME_RELAY         0x02    /*!< Time Role - Mesh Time Relay */
#define SSV_BLE_MESH_TIME_CLINET        0x03    /*!< Time Role - Mesh Time Client */

#define SSV_BLE_MESH_SCENE_SUCCESS      0x00    /*!< Scene operation - Success */
#define SSV_BLE_MESH_SCENE_REG_FULL     0x01    /*!< Scene operation - Scene Register Full */
#define SSV_BLE_MESH_SCENE_NOT_FOUND    0x02    /*!< Scene operation - Scene Not Found */
...
} ssv_ble_mesh_time_state_t;

/** User data of Time Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Time Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_time_state_t *state;           /*!< Parameters of the Time state */
} ssv_ble_mesh_time_srv_t;

/** User data of Time Setup Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Time Setup Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_time_state_t *state;           /*!< Parameters of the Time state */
} ssv_ble_mesh_time_setup_srv_t;
...
typedef struct {
    ...
    ssv_ble_mesh_scene_register_t *scenes;  /*!< Parameters of the Scenes state */
...
} ssv_ble_mesh_scenes_state_t;

/** User data of Scene Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Scene Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_scenes_state_t *state;         /*!< Parameters of the Scenes state */
...
} ssv_ble_mesh_scene_srv_t;

/** User data of Scene Setup Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Scene Setup Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_scenes_state_t *state;         /*!< Parameters of the Scenes state */
} ssv_ble_mesh_scene_setup_srv_t;
...
} ssv_ble_mesh_schedule_register_t;

/** Parameters of Scheduler state */
typedef struct {
    const uint8_t schedule_count;                   /*!< Scheduler count */
    ssv_ble_mesh_schedule_register_t *schedules;    /*!< Up to 16 scheduled entries */
} ssv_ble_mesh_scheduler_state_t;

/** User data of Scheduler Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Scheduler Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_scheduler_state_t *state;      /*!< Parameters of the Scheduler state */
} ssv_ble_mesh_scheduler_srv_t;

/** User data of Scheduler Setup Server Model */
typedef struct {
    ssv_ble_mesh_model_t *model;                /*!< Pointer to the Scheduler Setup Server Model. Initialized internally. */
    ssv_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    ssv_ble_mesh_scheduler_state_t *state;      /*!< Parameters of the Scheduler state */
} ssv_ble_mesh_scheduler_setup_srv_t;
...
} ssv_ble_mesh_state_change_time_set_t;
...
typedef struct {
    ...
    uint16_t tai_utc_delta_curr : 15;   /*!< Current difference between TAI and UTC in seconds */
    uint8_t  time_zone_offset_curr;     /*!< The local time zone offset in 15-minute increments */
} ssv_ble_mesh_state_change_time_status_t;

/** Parameters of Time Zone Set state change event */
typedef struct {
    uint8_t time_zone_offset_new;   /*!< Upcoming local time zone offset */
    uint8_t tai_zone_change[5];     /*!< TAI Seconds time of the upcoming Time Zone Offset change */
} ssv_ble_mesh_state_change_time_zone_set_t;

/** Parameters of TAI UTC Delta Set state change event */
typedef struct {
    uint16_t tai_utc_delta_new : 15;    /*!< Upcoming difference between TAI and UTC in seconds */
    uint8_t tai_delta_change[5];        /*!< TAI Seconds time of the upcoming TAI-UTC Delta change */
} ssv_ble_mesh_state_change_tai_utc_delta_set_t;

/** Parameter of Time Role Set state change event */
typedef struct {
    uint8_t time_role;      /*!< The Time Role for the element */
} ssv_ble_mesh_state_change_time_role_set_t;

/** Parameter of Scene Store state change event */
typedef struct {
    uint16_t scene_number;  /*!< The number of scenes to be stored */
} ssv_ble_mesh_state_change_scene_store_t;

/** Parameter of Scene Recall state change event */
typedef struct {
    uint16_t scene_number;  /*!< The number of scenes to be recalled */
} ssv_ble_mesh_state_change_scene_recall_t;

/** Parameter of Scene Delete state change event */
typedef struct {
    uint16_t scene_number;  /*!< The number of scenes to be deleted */
} ssv_ble_mesh_state_change_scene_delete_t;
...
} ssv_ble_mesh_state_change_scheduler_act_set_t;
...
typedef union {
     ...
     */
    ssv_ble_mesh_state_change_time_set_t          time_set;             /*!< Time Set */
    ssv_ble_mesh_state_change_time_status_t       time_status;          /*!< Time Status */
    ssv_ble_mesh_state_change_time_zone_set_t     time_zone_set;        /*!< Time Zone Set */
    ssv_ble_mesh_state_change_tai_utc_delta_set_t tai_utc_delta_set;    /*!< TAI UTC Delta Set */
    ssv_ble_mesh_state_change_time_role_set_t     time_role_set;        /*!< Time Role Set */
    ssv_ble_mesh_state_change_scene_store_t       scene_store;          /*!< Scene Store */
    ssv_ble_mesh_state_change_scene_recall_t      scene_recall;         /*!< Scene Recall */
    ssv_ble_mesh_state_change_scene_delete_t      scene_delete;         /*!< Scene Delete */
    ssv_ble_mesh_state_change_scheduler_act_set_t scheduler_act_set;    /*!< Scheduler Action Set */
} ssv_ble_mesh_time_scene_server_state_change_t;

/** Context of the received Scheduler Action Get message */
typedef struct {
    uint8_t index;  /*!< Index of the Schedule Register entry to get */
} ssv_ble_mesh_server_recv_scheduler_act_get_t;

/**
 * @brief Time Scene Server Model received get message union
 */
typedef union {
    ssv_ble_mesh_server_recv_scheduler_act_get_t scheduler_act; /*!< Scheduler Action Get */
} ssv_ble_mesh_time_scene_server_recv_get_msg_t;
...
typedef struct {
    ...
    uint16_t tai_utc_delta : 15;    /*!< Current difference between TAI and UTC in seconds */
    uint8_t  time_zone_offset;      /*!< The local time zone offset in 15-minute increments */
} ssv_ble_mesh_server_recv_time_set_t;

/** Context of the received Time Zone Set message */
typedef struct {
    uint8_t time_zone_offset_new;   /*!< Upcoming local time zone offset */
    uint8_t tai_zone_change[5];     /*!< TAI Seconds time of the upcoming Time Zone Offset change */
} ssv_ble_mesh_server_recv_time_zone_set_t;
...
typedef struct {
    ...
    uint16_t padding : 1;               /*!< Always 0b0. Other values are Prohibited. */
    uint8_t tai_delta_change[5];        /*!< TAI Seconds time of the upcoming TAI-UTC Delta change */
} ssv_ble_mesh_server_recv_tai_utc_delta_set_t;

/** Context of the received Time Role Set message */
typedef struct {
    uint8_t time_role;      /*!< The Time Role for the element */
} ssv_ble_mesh_server_recv_time_role_set_t;

/** Context of the received Scene Store message */
typedef struct {
    uint16_t scene_number;  /*!< The number of scenes to be stored */
} ssv_ble_mesh_server_recv_scene_store_t;
...
typedef struct {
    ...
    uint8_t  trans_time;    /*!< Time to complete state transition (optional) */
    uint8_t  delay;         /*!< Indicate message execution delay (C.1) */
} ssv_ble_mesh_server_recv_scene_recall_t;

/** Context of the received Scene Delete message */
typedef struct {
    uint16_t scene_number;  /*!< The number of scenes to be deleted */
} ssv_ble_mesh_server_recv_scene_delete_t;
...
typedef struct {
    ...
    uint64_t trans_time : 8;    /*!< Transition time for this action */
    uint16_t scene_number;      /*!< Scene number to be used for some actions */
} ssv_ble_mesh_server_recv_scheduler_act_set_t;

/**
 * @brief Time Scene Server Model received set message union
 */
typedef union {
    ssv_ble_mesh_server_recv_time_set_t          time;              /*!< Time Set */
    ssv_ble_mesh_server_recv_time_zone_set_t     time_zone;         /*!< Time Zone Set */
    ssv_ble_mesh_server_recv_tai_utc_delta_set_t tai_utc_delta;     /*!< TAI-UTC Delta Set */
    ssv_ble_mesh_server_recv_time_role_set_t     time_role;         /*!< Time Role Set */
    ssv_ble_mesh_server_recv_scene_store_t       scene_store;       /*!< Scene Store/Scene Store Unack */
    ssv_ble_mesh_server_recv_scene_recall_t      scene_recall;      /*!< Scene Recall/Scene Recall Unack */
    ssv_ble_mesh_server_recv_scene_delete_t      scene_delete;      /*!< Scene Delete/Scene Delete Unack */
    ssv_ble_mesh_server_recv_scheduler_act_set_t scheduler_act;     /*!< Scheduler Action Set/Scheduler Action Set Unack */
} ssv_ble_mesh_time_scene_server_recv_set_msg_t;
...
typedef struct {
    ...
    uint16_t tai_utc_delta : 15;    /*!< Current difference between TAI and UTC in seconds */
    uint8_t  time_zone_offset;      /*!< The local time zone offset in 15-minute increments */
} ssv_ble_mesh_server_recv_time_status_t;

/**
 * @brief Time Scene Server Model received status message union
 */
typedef union {
    ssv_ble_mesh_server_recv_time_status_t time_status;     /*!< Time Status */
} ssv_ble_mesh_time_scene_server_recv_status_msg_t;

/**
 * @brief Time Scene Server Model callback value union
 */
typedef union {
    ssv_ble_mesh_time_scene_server_state_change_t state_change; /*!< SSV_BLE_MESH_TIME_SCENE_SERVER_STATE_CHANGE_EVT */
    ssv_ble_mesh_time_scene_server_recv_get_msg_t get;  /*!< SSV_BLE_MESH_TIME_SCENE_SERVER_RECV_GET_MSG_EVT */
    ssv_ble_mesh_time_scene_server_recv_set_msg_t set;  /*!< SSV_BLE_MESH_TIME_SCENE_SERVER_RECV_SET_MSG_EVT */
    ssv_ble_mesh_time_scene_server_recv_status_msg_t status;    /*!< SSV_BLE_MESH_TIME_SCENE_SERVER_RECV_STATUS_MSG_EVT */
} ssv_ble_mesh_time_scene_server_cb_value_t;

/** Time Scene Server Model callback parameters */
typedef struct {
    ssv_ble_mesh_model_t  *model;   /*!< Pointer to Time and Scenes Server Models */
    ssv_ble_mesh_msg_ctx_t ctx;     /*!< Context of the received messages */
    ssv_ble_mesh_time_scene_server_cb_value_t value;    /*!< Value of the received Time and Scenes Messages */
} ssv_ble_mesh_time_scene_server_cb_param_t;
...
typedef enum {
     ...
     *    are received.
     */
    SSV_BLE_MESH_TIME_SCENE_SERVER_STATE_CHANGE_EVT,
    /**
     * When get_auto_rsp is set to SSV_BLE_MESH_SERVER_RSP_BY_APP, this event will be
     * callback to the application layer when Time Scene Get messages are received.
     */
    SSV_BLE_MESH_TIME_SCENE_SERVER_RECV_GET_MSG_EVT,
    /**
     ...
     */
    SSV_BLE_MESH_TIME_SCENE_SERVER_RECV_SET_MSG_EVT,
    /**
     ...
     */
    SSV_BLE_MESH_TIME_SCENE_SERVER_RECV_STATUS_MSG_EVT,
    SSV_BLE_MESH_TIME_SCENE_SERVER_EVT_MAX,
} ssv_ble_mesh_time_scene_server_cb_event_t;
 ...
 * @param   param: Pointer to callback parameter
 */
typedef void (* ssv_ble_mesh_time_scene_server_cb_t)(ssv_ble_mesh_time_scene_server_cb_event_t event,
        ssv_ble_mesh_time_scene_server_cb_param_t *param);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_register_time_scene_server_callback(ssv_ble_mesh_time_scene_server_cb_t callback);

#endif /* _SSV_BLE_MESH_TIME_SCENE_MODEL_API_H_ */
