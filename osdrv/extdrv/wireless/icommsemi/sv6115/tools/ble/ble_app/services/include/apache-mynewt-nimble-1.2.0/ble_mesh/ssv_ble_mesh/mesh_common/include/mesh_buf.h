...
struct net_buf {
    ...
    /** ack of mesh message, ssv ++ */
    u8_t ack:1;

    /** need ssv sync adv followed */
    u8_t need_synced_adv:1;
...
/*
 * ex:
 * static struct net_buf net_buf_adv_buf_pool[_count]
 * static u8_t u8_t net_buf_data_adv_buf_pool[_count][_data_size]
 * static const struct net_buf_pool_fixed net_buf_fixed_adv_buf_pool
 * static const struct net_buf_data_alloc net_buf_fixed_alloc_adv_buf_pool
 */
