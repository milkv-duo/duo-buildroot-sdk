...
#ifndef _SSV_BLE_MESH_PROXY_API_H_
#define _SSV_BLE_MESH_PROXY_API_H_
 ...
 *
 */
ssv_err_t ssv_ble_mesh_proxy_identity_enable(void);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_proxy_gatt_enable(void);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_proxy_gatt_disable(void);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_proxy_client_connect(ssv_ble_mesh_bd_addr_t addr,
        ssv_ble_mesh_addr_type_t addr_type, uint16_t net_idx);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_proxy_client_disconnect(uint8_t conn_handle);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_proxy_client_set_filter_type(uint8_t conn_handle,
        uint16_t net_idx, ssv_ble_mesh_proxy_filter_type_t filter_type);
 ...
 *
 */
ssv_err_t ssv_ble_mesh_proxy_client_add_filter_addr(uint8_t conn_handle,
 ...
 *
 */
ssv_err_t ssv_ble_mesh_proxy_client_remove_filter_addr(uint8_t conn_handle,
        uint16_t net_idx, uint16_t *addr, uint16_t addr_num);

#endif /* _SSV_BLE_MESH_PROXY_API_H_ */
