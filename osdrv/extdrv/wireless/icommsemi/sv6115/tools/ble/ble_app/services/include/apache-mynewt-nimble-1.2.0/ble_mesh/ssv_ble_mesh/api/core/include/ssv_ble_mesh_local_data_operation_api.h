...
#ifndef _SSV_BLE_MESH_LOCAL_DATA_OPERATION_API_H_
#define _SSV_BLE_MESH_LOCAL_DATA_OPERATION_API_H_
 ...
 *
 */
int32_t ssv_ble_mesh_get_model_publish_period(ssv_ble_mesh_model_t *model);

/**
 * @brief         Get the address of the primary element.
 *
 * @return        Address of the primary element on success, or
 *                SSV_BLE_MESH_ADDR_UNASSIGNED on failure which means the device has not been provisioned.
 *
 */
uint16_t ssv_ble_mesh_get_primary_element_address(void);
 ...
 *
 */
uint16_t *ssv_ble_mesh_is_model_subscribed_to_group(ssv_ble_mesh_model_t *model, uint16_t group_addr);
 ...
 *
 */
ssv_ble_mesh_elem_t *ssv_ble_mesh_find_element(uint16_t element_addr);
 ...
 *
 */
uint8_t ssv_ble_mesh_get_element_count(void);
 ...
 *
 */
ssv_ble_mesh_model_t *ssv_ble_mesh_find_vendor_model(const ssv_ble_mesh_elem_t *element,
 ...
 *
 */
ssv_ble_mesh_model_t *ssv_ble_mesh_find_sig_model(const ssv_ble_mesh_elem_t *element, uint16_t model_id);
 ...
 *
 */
const ssv_ble_mesh_comp_t *ssv_ble_mesh_get_composition_data(void);

#endif /* _SSV_BLE_MESH_LOCAL_DATA_OPERATION_API_H_ */
