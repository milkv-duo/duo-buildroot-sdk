	...
	IN UCHAR *pRspIe, IN UINT32 RspIeLen)
{
	...
	rRoamInfo.bssid = pBSSID;
	rRoamInfo.req_ie = pReqIe;
	rRoamInfo.req_ie_len = ReqIeLen;
	rRoamInfo.resp_ie = pRspIe;
	rRoamInfo.resp_ie_len = RspIeLen;
...
#if (KERNEL_VERSION(4, 3, 0) <= LINUX_VERSION_CODE)
		/*Fix kernel 4.19 parser channel reg domain info*/
