...
#ifdef WPA3_SUPPORT
	CMD_RTPRIV_IOCTL_80211_P2PCLI_AUTH_IE_SET,
#endif
...
#ifdef WPA3_SUPPORT
#define AUTH_DATA_MAX_LEN 512 /* temp defined */
#define AUTH_IE_MAX_LEN 1024 /* temp defined*/
...
typedef struct __CMD_RTPRIV_IOCTL_80211_CONNECT {
...
#endif /* DOT11W_PMF_SUPPORT */
#ifdef WPA3_SUPPORT
	UINT8 aucKek[NL80211_KEK_LEN];
	UINT8 aucKck[NL80211_KCK_LEN];
	UINT8 aucReplayCtr[NL80211_REPLAY_CTR_LEN];
	...
	BOOLEAN aucExtraIe[AUTH_IE_MAX_LEN];
	UINT8 ucExtraIeLen;
#endif
#ifdef CFG_SUPPORT_OWE
...
#ifdef WPA3_SUPPORT
	CMD_RTPRIV_IOCTL_STA_SIOCSIWGENAUTHIE,
#endif
