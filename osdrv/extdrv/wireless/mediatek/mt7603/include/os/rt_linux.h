...
#define STA_PROFILE_PATH                        "/vendor/etc/Wireless/RT2870STA/MT7603USTA.dat"
#else
...
#define STA_DRIVER_VERSION			"JEDI.L0.MP1.mt7603u.v1.18_e21d6"
#ifdef MULTIPLE_CARD_SUPPORT
...
typedef void (*TIMER_FUNCTION)(OS_NDIS_MINIPORT_TIMER *);
#else
