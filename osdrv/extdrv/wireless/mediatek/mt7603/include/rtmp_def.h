...
#define MAX_NUM_SUPPORTED_CIPHER_SUITES 16
...
#ifdef CFG_SUPPORT_802_11W
#define ELEM_WPA_CAP_PREAUTH                        BIT(0)
...
#ifdef WPA3_SUPPORT
#define RT_CMD_80211_CONN_ENCRYPT_GROUP_NOT_USED 0x70
#define RT_CMD_80211_CONN_ENCRYPT_GCMP256 0x80
#endif

#ifdef WPA3_SUPPORT
/* ----- Definitions for Cipher Suite Selectors ----- */
#define RSN_CIPHER_SUITE_USE_GROUP_KEY  0x000FAC00
#define RSN_CIPHER_SUITE_WEP40          0x000FAC01
#define RSN_CIPHER_SUITE_TKIP           0x000FAC02
#define RSN_CIPHER_SUITE_CCMP           0x000FAC04
#define RSN_CIPHER_SUITE_WEP104         0x000FAC05
#ifdef CFG_SUPPORT_802_11W
#define RSN_CIPHER_SUITE_AES_128_CMAC   0x000FAC06
#endif
#define RSN_CIPHER_SUITE_GROUP_NOT_USED 0x000FAC07
#define RSN_CIPHER_SUITE_GCMP           0x000FAC08
#define RSN_CIPHER_SUITE_GCMP_256       0x000FAC09
#define RSN_CIPHER_SUITE_CCMP_256       0x000FAC0A
#ifdef CFG_SUPPORT_802_11W
#define RSN_CIPHER_SUITE_BIP_GMAC_128   0x000FAC0B
#define RSN_CIPHER_SUITE_BIP_GMAC_256   0x000FAC0C
#define RSN_CIPHER_SUITE_BIP_CMAC_256   0x000FAC0D
#endif

#define WPA_CIPHER_SUITE_NONE           0x0050F200
#define WPA_CIPHER_SUITE_WEP40          0x0050F201
#define WPA_CIPHER_SUITE_TKIP           0x0050F202
#define WPA_CIPHER_SUITE_CCMP           0x0050F204
#define WPA_CIPHER_SUITE_WEP104         0x0050F205

/* ----- Definitions for Authentication and Key Management Suite Selectors ----- */
#define RSN_AKM_SUITE_NONE              0x000FAC00
#define RSN_AKM_SUITE_802_1X            0x000FAC01
#define RSN_AKM_SUITE_PSK               0x000FAC02
#ifdef CFG_SUPPORT_802_11W
#define RSN_AKM_SUITE_802_1X_SHA256     0x000FAC05
#define RSN_AKM_SUITE_PSK_SHA256        0x000FAC06
#endif
#define RSN_AKM_SUITE_SAE               0x000FAC08
#define RSN_AKM_SUITE_8021X_SUITE_B     0x000FAC0B
#define RSN_AKM_SUITE_8021X_SUITE_B_192 0x000FAC0C
#define RSN_AKM_SUITE_OWE               0x000FAC12

#define WPA_AKM_SUITE_NONE              0x0050F200
...
#ifdef WPA3_SUPPORT
#define CIPHER_GROUP_NOT_USED 11
#define CIPHER_GCMP           12
#define CIPHER_GCMP_256       13
#define CIPHER_CCMP_256       14
#define CIPHER_BIP_GMAC_128   15
#define CIPHER_BIP_GMAC_256   16
#define CIPHER_BIP_CMAC_256   17

/* Authentication Retry Limit */
#define TX_ASSOC_RETRY_LIMIT                  2
#endif
...
#define WLAN_GET_FIELD_16(_memAddr_p, _value_p) \
	{ \
		PUINT8 __cp = (PUINT8)(_memAddr_p); \
		*(PUINT16)(_value_p) = ((UINT16)__cp[0]) | ((UINT16)__cp[1] << 8); \
	}

#define WLAN_GET_FIELD_BE16(_memAddr_p, _value_p) \
	{ \
		PUINT8 __cp = (PUINT8)(_memAddr_p); \
		*(PUINT16)(_value_p) = ((UINT16)__cp[0] << 8) | ((UINT16)__cp[1]); \
	}

#define WLAN_GET_FIELD_32(_memAddr_p, _value_p) \
	{ \
		PUINT8 __cp = (PUINT8)(_memAddr_p); \
		*(PUINT32)(_value_p) = ((UINT32)__cp[0]) | ((UINT32)__cp[1] << 8) | \
					((UINT32)__cp[2] << 16) | ((UINT32)__cp[3] << 24); \
	}
...
#define WLAN_GET_FIELD_64(_memAddr_p, _value_p) \
	{ \
		PUINT8 __cp = (PUINT8)(_memAddr_p); \
		*(PUINT64)(_value_p) = \
			((UINT64)__cp[0]) | ((UINT64)__cp[1] << 8) | \
			((UINT64)__cp[2] << 16) | ((UINT64)__cp[3] << 24) | \
			((UINT64)__cp[4] << 32) | ((UINT64)__cp[5] << 40) | \
			((UINT64)__cp[6] << 48) | ((UINT64)__cp[7] << 56); \
	}

/* The macro to check if the MAC address is B/MCAST Address */
#define IS_BMCAST_MAC_ADDR(_pucDestAddr)            \
	((BOOLEAN) (((PUINT8)(_pucDestAddr))[0] & BIT(0)))
