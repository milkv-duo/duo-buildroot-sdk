...
void (*RTMPFreeAdapterBlock)(void *pAd);
...
#define RTMPFreeAdapterBlock (((RTMP_DRV_ABL_OPS *)(pRtmpDrvOps))->RTMPFreeAdapterBlock)
...
#ifdef WPA3_SUPPORT
#define RTMP_DRIVER_80211_GEN_AUTH_IE_SET(__pAd, __pData, __Len)	\
	RTMP_STA_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_STA_SIOCSIWGENAUTHIE, 0, __pData, __Len, 0)
#endif
...
#ifdef WPA3_SUPPORT
#define RTMP_DRIVER_80211_P2PCLI_AUTH_IE_SET(__pAd, __pFrame, __Len)                       \
		RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_80211_P2PCLI_AUTH_IE_SET, 0, __pFrame, __Len)
#endif
