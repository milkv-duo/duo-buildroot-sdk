#ifndef DWC2_DRV_IF_H
#define DWC2_DRV_IF_H
...
struct usb_gadget_driver {
	...
	void			*(*req_mem_alloc)(struct usb_gadget *gadget, uint32_t requireSize);
	void			(*req_mem_free)(struct usb_gadget *gadget, void *usbRequest);
};
