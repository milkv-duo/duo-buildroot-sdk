...
#define	CH9_USB_DIR_DEVICE_TO_HOST (1 << 7)
...
#define	CH9_USB_REQ_TYPE_CLASS (1 << 5)
...
#define	CH9_USB_STATUS_DEV_SELF_POWERED (1 << 0)

#define	CH9_USB_STATUS_DEV_REMOTE_WAKEUP (1 << 1)

#define	CH9_USB_STATUS_DEV_U1_ENABLE (1 << 2)

#define	CH9_USB_STATUS_DEV_U2_ENABLE (1 << 3)

#define	CH9_USB_STATUS_DEV_LTM_ENABLE (1 << 4)

/** Recipient Interface (Figure 9-5 of USB Spec) */
#define	CH9_USB_STATUS_INT_REMOTE_WAKE_CAPABLE (1 << 0)

#define	CH9_USB_STATUS_INT_REMOTE_WAKEUP (1 << 1)

/** Recipient Endpoint (Figure 9-6 of USB Spec) */
#define	CH9_USB_STATUS_EP_HALT (1 << 1)

/** Recipient Endpoint - PTM GetStatus Request(Figure 9-7 of USB Spec) */
#define	CH9_USB_STATUS_EP_PTM_ENABLE (1 << 0)

#define	CH9_USB_STATUS_EP_PTM_VALID (1 << 1)
...
/**
 * Macros describing information for SetFeauture Request and FUCTION_SUSPEND selector
...
#define	CH9_USB_USB20_EXT_LPM_SUPPORT (1 << 1)

#define	CH9_USB_USB20_EXT_BESL_AND_ALTERNATE_HIRD (1 << 2)

/**
 * Describe supports LTM defined in bmAttribues field
 * of CUSBD_UsbSuperSpeedDeviceCapabilityDescriptor
 */
#define	CH9_USB_SS_CAP_LTM (1 << 1)

/**
 * Describe speed supported defined in wSpeedSupported field
 * of CUSBD_UsbSuperSpeedDeviceCapabilityDescriptor
 */
#define	CH9_USB_SS_CAP_SUPPORT_LS (1 << 0)

#define	CH9_USB_SS_CAP_SUPPORT_FS (1 << 1)

#define	CH9_USB_SS_CAP_SUPPORT_HS (1 << 2)

#define	CH9_USB_SS_CAP_SUPPORT_SS (1 << 3)
...
#define	CH9_USB_CONFIG_RESERVED (1 << 7)

/** Self Powered */
#define	CH9_USB_CONFIG_SELF_POWERED (1 << 6)

#define CH9_USB_CONFIG_BUS_POWERED (1 << 7)

/** Remote Wakeup */
#define	CH9_USB_CONFIG_REMOTE_WAKEUP (1 << 5)
...
TYPEDEF struct CH9_UsbSetup {
	...
	uint16_t wLength;
} __packed __aligned(__alignof__(unsigned long)) CH9_UsbSetup;
